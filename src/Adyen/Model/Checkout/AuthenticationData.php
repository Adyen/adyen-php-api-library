...
class AuthenticationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AuthenticationData';
    ...
    */
     ...
     * @return self
     */
    public function setAttemptAuthentication($attemptAuthentication): self
    {
     ...
     * @return self
     */
    public function setThreeDSRequestData($threeDSRequestData): self
    {
