...
class ShopperInteractionDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ShopperInteractionDevice';
    ...
    */
     ...
     * Sets osVersion
     *
     * @param string|null $osVersion Version of the operating system on the shopper interaction device.
     *
     * @return self
     */
