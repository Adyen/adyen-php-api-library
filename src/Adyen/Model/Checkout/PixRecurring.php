...
class PixRecurring implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PixRecurring';
    ...
    */
     ...
     * @return self
     */
    public function setBillingDate($billingDate): self
    {
     ...
     * @return self
     */
    public function setBusinessDayOnly($businessDayOnly): self
    {
     ...
     * @return self
     */
    public function setOriginalPspReference($originalPspReference): self
    {
