...
/**
 * PaymentReversalRequest Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentReversalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentReversalRequest';
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference Your reference for the reversal request. Maximum length: 80 characters.
     *
     * @return self
     */
