...
/**
 * CheckoutForwardResponse Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class CheckoutForwardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CheckoutForwardResponse';
    ...
    */
     ...
     * Sets pspReference
     *
     * @param string|null $pspReference Adyen's 16-character reference associated with the transaction/request. This value is globally unique. Use this reference when you communicate with us about this request.
     *
     * @return self
     */
     ...
     * Gets response
     *
     * @return \Adyen\Model\Checkout\CheckoutForwardResponseFromUrl
     */
     ...
     * Sets response
     *
     * @param \Adyen\Model\Checkout\CheckoutForwardResponseFromUrl $response response
     *
     * @return self
     */
     ...
     *
     * @param string|null $storedPaymentMethodId The unique identifier of the token.
     *
     * @return self
     */
