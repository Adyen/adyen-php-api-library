...
class AppIdentifierInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AppIdentifierInfo';
    ...
    */
     ...
     * @return self
     */
    public function setAndroidPackageId($androidPackageId): self
    {
     ...
     * @return self
     */
    public function setIosScheme($iosScheme): self
    {
