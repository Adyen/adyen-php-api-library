...
class StoredPaymentMethodResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StoredPaymentMethodResource';
    ...
    */
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt The date when the recurring details were created.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setExternalResponseCode($externalResponseCode): self
    {
     ...
     * @return self
     */
    public function setExternalTokenReference($externalTokenReference): self
    {
     ...
     *
     * @param string|null $firstPspReference The PSP reference of the first payment that created this recurring detail.
     *
     * @return self
     */
    public function setFirstPspReference($firstPspReference): self
    {
