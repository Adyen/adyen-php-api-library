...
/**
 * PayPayDetails Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class PayPayDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayPayDetails';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'paypay');
    }
