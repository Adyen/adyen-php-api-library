...
/**
 * PaymentDonationRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentDonationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentDonationRequest';
    ...
    protected static $openAPITypes = [
        ...
        'donation_original_psp_reference' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'donation_original_psp_reference' => null,
        'donation_token' => null,
    ...
    protected static $openAPINullables = [
        ...
        'donation_original_psp_reference' => false,
    ...
    protected static $setters = [
        ...
        'donation_original_psp_reference' => 'setDonationOriginalPspReference',
    ...
    protected static $getters = [
        ...
        'donation_original_psp_reference' => 'getDonationOriginalPspReference',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('donation_original_psp_reference', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['device_fingerprint']) && (mb_strlen($this->container['device_fingerprint']) > 5000)) {
            $invalidProperties[] = "invalid value for 'device_fingerprint', the character length must be smaller than or equal to 5000.";
        }
        ...
        if (!is_null($this->container['origin']) && (mb_strlen($this->container['origin']) > 8000)) {
            $invalidProperties[] = "invalid value for 'origin', the character length must be smaller than or equal to 8000.";
        }
    ...
    public function setDeviceFingerprint($device_fingerprint)
    {
        ...
        if ((mb_strlen($device_fingerprint) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $device_fingerprint when calling PaymentDonationRequest., must be smaller than or equal to 5000.');
        }
     ...
     *
     * @param string $donation_account Donation account to which the transaction is credited.
     *
     * @return self
     */
    ...
    /**
     * Gets donation_original_psp_reference
     *
     * @return string|null
     */
    public function getDonationOriginalPspReference()
    {
        return $this->container['donation_original_psp_reference'];
    }

    /**
     * Sets donation_original_psp_reference
     *
     * @param string|null $donation_original_psp_reference PSP reference of the transaction from which the donation token is generated. Required when `donationToken` is provided.
     *
     * @return self
     */
    public function setDonationOriginalPspReference($donation_original_psp_reference)
    {
        if (is_null($donation_original_psp_reference)) {
            throw new \InvalidArgumentException('non-nullable donation_original_psp_reference cannot be null');
        }
        $this->container['donation_original_psp_reference'] = $donation_original_psp_reference;
     ...
     * Sets donation_token
     *
     * @param string|null $donation_token Donation token received in the `/payments` call.
     *
     * @return self
     */
    ...
    public function setOrigin($origin)
    {
        ...
        if ((mb_strlen($origin) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $origin when calling PaymentDonationRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling PaymentDonationRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setStore($store)
    {
        ...
        if ((mb_strlen($store) > 16)) {
            throw new \InvalidArgumentException('invalid length for $store when calling PaymentDonationRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($store) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store when calling PaymentDonationRequest., must be bigger than or equal to 1.');
        }
