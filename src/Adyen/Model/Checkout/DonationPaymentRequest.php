...
class DonationPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DonationPaymentRequest';
    ...
    */
     ...
     * @return self
     */
    public function setDonationAccount($donationAccount): self
    {
     ...
     * @return self
     */
    public function setDonationCampaignId($donationCampaignId): self
    {
     ...
     * @return self
     */
    public function setDonationOriginalPspReference($donationOriginalPspReference): self
    {
     ...
     * @return self
     */
    public function setDonationToken($donationToken): self
    {
