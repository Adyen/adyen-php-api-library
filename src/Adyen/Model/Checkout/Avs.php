...
class Avs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'address_editable' => 'setAddressEditable',
        'enabled' => 'setEnabled'
    ];
    ...
    protected static $getters = [
        'address_editable' => 'getAddressEditable',
        'enabled' => 'getEnabled'
    ];
    ...
    {
        $this->setIfExists('address_editable', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets address_editable
     *
     * @return bool|null
     */
    public function getAddressEditable()
    {
        return $this->container['address_editable'];
    }

    /**
     * Sets address_editable
     *
     * @param bool|null $address_editable Indicates whether the shopper is allowed to modify the billing address for the current payment request.
     *
     * @return self
     */
    public function setAddressEditable($address_editable)
    {
        if (is_null($address_editable)) {
            throw new \InvalidArgumentException('non-nullable address_editable cannot be null');
        }
        $this->container['address_editable'] = $address_editable;
