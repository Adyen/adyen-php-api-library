...
class ItemDetailLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ItemDetailLine';
    ...
    */
     ...
     * @return self
     */
    public function setCommodityCode($commodityCode): self
    {
     ...
     * Sets discountAmount
     *
     * @param int|null $discountAmount The discount amount, in [minor units](https://docs.adyen.com/development-resources/currency-codes). * For example, 2000 means USD 20.00. * Encoding: Numeric * Max value: 10000000000 * **additionalData key:** `enhancedSchemeData.itemDetailLine[N].discountAmount`
     *
     * @return self
     */
     ...
     * Sets productCode
     *
     * @param string|null $productCode The product code. Must be a unique product code associated with the item or service. This can be your unique code for the item, or the manufacturer's product code.  * Encoding: ASCII. * Max length: 12 characters * **additionalData key:** `enhancedSchemeData.itemDetailLine[N].productCode`
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The number of items. Must be an integer greater than zero. * Encoding: Numeric * Max value: 9999 * **additionalData key:** `enhancedSchemeData.itemDetailLine[N].quantity`
     *
     * @return self
     */
     ...
     * Sets unitOfMeasure
     *
     * @param string|null $unitOfMeasure The unit of measurement for an item. * Encoding: ASCII * Max length: 3 characters * **additionalData key:** `enhancedSchemeData.itemDetailLine[N].unitOfMeasure`
     *
     * @return self
     */
    public function setUnitOfMeasure($unitOfMeasure): self
    {
     ...
     * Sets unitPrice
     *
     * @param int|null $unitPrice The unit price, in [minor units](https://docs.adyen.com/development-resources/currency-codes). * For example, 2000 means USD 20.00. * Encoding: Numeric * Max value: 10000000000 * **additionalData key:** `enhancedSchemeData.itemDetailLine[N].unitPrice`
     *
     * @return self
     */
