...
class Donation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Donation';
    ...
    */
     ...
     * @return self
     */
    public function setMaxRoundupAmount($maxRoundupAmount): self
    {
