...
/**
 * CreateStandalonePaymentCancelRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CreateStandalonePaymentCancelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStandalonePaymentCancelRequest';
    ...
    */
     ...
     *
     * @param string $payment_reference The [`reference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__reqParam_reference) of the payment that you want to cancel.
     *
     * @return self
     */
