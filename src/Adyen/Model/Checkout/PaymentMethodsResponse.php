...
class PaymentMethodsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentMethodsResponse';
    ...
    */
     ...
     * Sets paymentMethods
     *
     * @param \Adyen\Model\Checkout\PaymentMethod[]|null $paymentMethods Detailed list of payment methods required to generate payment forms.
     *
     * @return self
     */
