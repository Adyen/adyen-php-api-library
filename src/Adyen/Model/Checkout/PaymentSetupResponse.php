...
class PaymentSetupResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'recurringDetails' => '\Adyen\Model\Checkout\RecurringDetail[]'
    ];
    ...
    {
        $this->setIfExists('paymentSession', $data ?? [], null);
        $this->setIfExists('recurringDetails', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['paymentSession'];
    }

    /**
     * Sets paymentSession
     *
     * @param string|null $paymentSession The encoded payment session that you need to pass to the SDK.
     *
     * @return self
     */
     ...
     *
     * @param \Adyen\Model\Checkout\RecurringDetail[]|null $recurringDetails The detailed list of stored payment details required to generate payment forms. Will be empty if oneClick is set to false in the request.
     *
     * @return self
     * @deprecated
     */
