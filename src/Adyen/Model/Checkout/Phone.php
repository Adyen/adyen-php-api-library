...
class Phone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cc']) && (mb_strlen($this->container['cc']) > 3)) {
            $invalidProperties[] = "invalid value for 'cc', the character length must be smaller than or equal to 3.";
        }
        ...
        if (!is_null($this->container['subscriber']) && (mb_strlen($this->container['subscriber']) > 15)) {
            $invalidProperties[] = "invalid value for 'subscriber', the character length must be smaller than or equal to 15.";
        }
    ...
    public function setCc($cc)
    {
        ...
        if ((mb_strlen($cc) > 3)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling Phone., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($cc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling Phone., must be bigger than or equal to 1.');
        }
    ...
    public function setSubscriber($subscriber)
    {
        ...
        if ((mb_strlen($subscriber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $subscriber when calling Phone., must be smaller than or equal to 15.');
        }
