...
class Split implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Split';
    ...
    protected static array $openAPITypes = [
        'account' => 'string',
        'amount' => '\Adyen\Model\Checkout\SplitAmount',
        'description' => 'string',
        'reference' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets amount
     *
     * @return \Adyen\Model\Checkout\SplitAmount|null
     */
     ...
     * Sets amount
     *
     * @param \Adyen\Model\Checkout\SplitAmount|null $amount amount
     *
     * @return self
     */
