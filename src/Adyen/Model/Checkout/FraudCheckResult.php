...
class FraudCheckResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FraudCheckResult';
    ...
    */
     ...
     * Sets accountScore
     *
     * @param int $accountScore The fraud score generated by the risk check.
     *
     * @return self
     */
     ...
     * Sets checkId
     *
     * @param int $checkId The ID of the risk check.
     *
     * @return self
     */
    public function setCheckId($checkId): self
    {
