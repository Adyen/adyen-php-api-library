...
/**
 * PaymentAmountUpdateRequest Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class PaymentAmountUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAmountUpdateRequest';
    ...
    protected static $openAPINullables = [
        'adjustAuthType' => false,
        'adjustAuthorisationData' => false,
        'amount' => false,
    ...
    protected static $setters = [
        'adjustAuthType' => 'setAdjustAuthType',
        'adjustAuthorisationData' => 'setAdjustAuthorisationData',
        'amount' => 'setAmount',
    ...
    protected static $getters = [
        'adjustAuthType' => 'getAdjustAuthType',
        'adjustAuthorisationData' => 'getAdjustAuthorisationData',
        'amount' => 'getAmount',
    ...
    public const ADJUST_AUTH_TYPE_CARDHOLDER_INITIATED_TRANSACTION = 'cardholderInitiatedTransaction';
    public const ADJUST_AUTH_TYPE_MERCHANT_INITIATED_TRANSACTION = 'merchantInitiatedTransaction';
     ...
     * @return string[]
     */
    public function getAdjustAuthTypeAllowableValues()
    {
        return [
            self::ADJUST_AUTH_TYPE_CARDHOLDER_INITIATED_TRANSACTION,
            self::ADJUST_AUTH_TYPE_MERCHANT_INITIATED_TRANSACTION,
        ];
    }
    /**
     * Gets allowable values of the enum
    ...
    {
        $this->setIfExists('adjustAuthType', $data ?? [], null);
        $this->setIfExists('adjustAuthorisationData', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['adjustAuthType']) && !in_array($this->container['adjustAuthType'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'adjustAuthType', must be one of '%s'",
                $this->container['adjustAuthType'],
     ...
     * @return string|null
     */
    public function getAdjustAuthType()
    {
        return $this->container['adjustAuthType'];
    }

    /**
     * Sets adjustAuthType
     *
     * @param string|null $adjustAuthType The type of adjustment. Possible values:   * **cardholderInitiatedTransaction**   * **merchantInitiatedTransaction**
     *
     * @return self
     */
    public function setAdjustAuthType($adjustAuthType)
    {
        $allowedValues = $this->getAdjustAuthTypeAllowableValues();
        if (!in_array($adjustAuthType, $allowedValues, true)) {
            error_log(
                sprintf(
                    "adjustAuthType: unexpected enum value '%s' - Supported values are [%s]",
                    $adjustAuthType,
                    implode(', ', $allowedValues)
                )
            );
        }
        $this->container['adjustAuthType'] = $adjustAuthType;

        return $this;
    }

    /**
     * Gets adjustAuthorisationData
     *
     * @return string|null
     */
    public function getAdjustAuthorisationData()
    {
        return $this->container['adjustAuthorisationData'];
    }

    /**
     * Sets adjustAuthorisationData
     *
     * @param string|null $adjustAuthorisationData The required data to make a [synchronous authorization adjustment](https://docs.adyen.com/online-payments/adjust-authorisation). Pass the corresponding value from the `/payments` response or webhook message.
     *
     * @return self
     */
    public function setAdjustAuthorisationData($adjustAuthorisationData)
    {
        $this->container['adjustAuthorisationData'] = $adjustAuthorisationData;
