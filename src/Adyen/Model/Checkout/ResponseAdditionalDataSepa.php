...
class ResponseAdditionalDataSepa implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseAdditionalDataSepa';
    ...
    */
     ...
     * @return self
     */
    public function setSepadirectdebitDateOfSignature($sepadirectdebitDateOfSignature): self
    {
     ...
     * @return self
     */
    public function setSepadirectdebitMandateId($sepadirectdebitMandateId): self
    {
     ...
     * @return self
     */
    public function setSepadirectdebitSepadirectdebitDueDate($sepadirectdebitSepadirectdebitDueDate): self
    {
     ...
     * @return self
     */
    public function setSepadirectdebitSequenceType($sepadirectdebitSequenceType): self
    {
