...
class ResponseAdditionalDataDomesticError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseAdditionalDataDomesticError';
    ...
    */
     ...
     * @return self
     */
    public function setDomesticRefusalReasonRaw($domesticRefusalReasonRaw): self
    {
     ...
     * @return self
     */
    public function setDomesticShopperAdvice($domesticShopperAdvice): self
    {
