...
class CheckoutBalanceCheckRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['totals_group']) && (mb_strlen($this->container['totals_group']) > 16)) {
            $invalidProperties[] = "invalid value for 'totals_group', the character length must be smaller than or equal to 16.";
        }

        if (!is_null($this->container['totals_group']) && (mb_strlen($this->container['totals_group']) < 1)) {
            $invalidProperties[] = "invalid value for 'totals_group', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setDeviceFingerprint($device_fingerprint)
    {
        ...
        if ((mb_strlen($device_fingerprint) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $device_fingerprint when calling CheckoutBalanceCheckRequest., must be smaller than or equal to 5000.');
        }
    ...
    public function setStore($store)
    {
        ...
        if ((mb_strlen($store) > 16)) {
            throw new \InvalidArgumentException('invalid length for $store when calling CheckoutBalanceCheckRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($store) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store when calling CheckoutBalanceCheckRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalsGroup($totals_group)
    {
        ...
        if ((mb_strlen($totals_group) > 16)) {
            throw new \InvalidArgumentException('invalid length for $totals_group when calling CheckoutBalanceCheckRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($totals_group) < 1)) {
            throw new \InvalidArgumentException('invalid length for $totals_group when calling CheckoutBalanceCheckRequest., must be bigger than or equal to 1.');
        }
