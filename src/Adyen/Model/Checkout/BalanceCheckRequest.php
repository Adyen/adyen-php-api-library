...
/**
 * BalanceCheckRequest Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class BalanceCheckRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BalanceCheckRequest';
    ...
    */
     ...
     * Sets paymentMethod
     *
     * @param array<string,string> $paymentMethod The collection that contains the type of the payment method and its specific information.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setSelectedBrand($selectedBrand): self
    {
     ...
     * @return self
     */
    public function setTotalsGroup($totalsGroup): self
    {
