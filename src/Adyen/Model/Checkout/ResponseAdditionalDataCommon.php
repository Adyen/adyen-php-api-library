...
class ResponseAdditionalDataCommon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets fraudRiskLevel
     *
     * @param string|null $fraudRiskLevel The risk level of the payment as determined by the FDM machine learning model.
     *
     * @return self
     */
