...
class PaymentLinkResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentLinkResponse';
    ...
    */
     ...
     * @return self
     */
    public function setManualCapture($manualCapture): self
    {
     ...
     * @return self
     */
    public function setRequiredShopperFields($requiredShopperFields): self
    {
     ...
     * @return self
     */
    public function setReusable($reusable): self
    {
