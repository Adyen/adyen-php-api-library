...
/**
 * CheckoutCancelOrderResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class CheckoutCancelOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutCancelOrderResponse';
    ...
    */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference A unique reference of the cancellation request.
     *
     * @return self
     */
     ...
     * Sets result_code
     *
     * @param string $result_code The result of the cancellation request.  Possible values:  * **Received** – Indicates the cancellation has successfully been received by Adyen, and will be processed.
     *
     * @return self
     */
