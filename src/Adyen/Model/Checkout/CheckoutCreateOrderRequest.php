...
/**
 * CheckoutCreateOrderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CheckoutCreateOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutCreateOrderRequest';
    ...
    */
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at The date that order expires; e.g. 2019-03-23T12:25:28Z. If not provided, the default expiry duration is 1 day.
     *
     * @return self
     */
     ...
     *
     * @param string $merchant_account The merchant account identifier, with which you want to process the order.
     *
     * @return self
     */
