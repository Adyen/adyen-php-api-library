...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['city']) > 3000)) {
            $invalidProperties[] = "invalid value for 'city', the character length must be smaller than or equal to 3000.";
        }
        ...
        if ((mb_strlen($this->container['house_number_or_name']) > 3000)) {
            $invalidProperties[] = "invalid value for 'house_number_or_name', the character length must be smaller than or equal to 3000.";
        }
        ...
        if ((mb_strlen($this->container['street']) > 3000)) {
            $invalidProperties[] = "invalid value for 'street', the character length must be smaller than or equal to 3000.";
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Address., must be smaller than or equal to 3000.');
        }
    ...
    public function setHouseNumberOrName($house_number_or_name)
    {
        ...
        if ((mb_strlen($house_number_or_name) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $house_number_or_name when calling Address., must be smaller than or equal to 3000.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if ((mb_strlen($street) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Address., must be smaller than or equal to 3000.');
        }
