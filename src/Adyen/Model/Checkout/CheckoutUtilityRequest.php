...
class CheckoutUtilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['origin_domains'] === null) {
            $invalidProperties[] = "'origin_domains' can't be null";
        }
     ...
     * Sets origin_domains
     *
     * @param string[] $origin_domains The list of origin domains, for which origin keys are requested.
     *
     * @return self
     */
