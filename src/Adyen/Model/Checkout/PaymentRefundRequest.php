...
class PaymentRefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentRefundRequest';
    ...
    */
     ...
     * @return self
     */
    public function setCapturePspReference($capturePspReference): self
    {
     ...
     * @return self
     */
    public function setMerchantRefundReason($merchantRefundReason): self
    {
