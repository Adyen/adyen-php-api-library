...
class StoredPaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'StoredPaymentMethod';
    ...
    protected static array $setters = [
        ...
        'externalToken' => 'setExternalToken',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('externalToken', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['externalToken'];
    }

    /**
     * Sets externalToken
     *
     * @param string|null $externalToken The token issued by an external tokenization service representing the shopper's payment method
     *
     * @return self
     */
    public function setExternalToken($externalToken): self
    {
        $this->container['externalToken'] = $externalToken;
     ...
     * @return self
     */
    public function setSupportedRecurringProcessingModels($supportedRecurringProcessingModels): self
    {
     ...
     * @return self
     */
    public function setSupportedShopperInteractions($supportedShopperInteractions): self
    {
