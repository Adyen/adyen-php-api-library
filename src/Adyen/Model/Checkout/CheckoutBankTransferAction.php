...
class CheckoutBankTransferAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CheckoutBankTransferAction';
    ...
    */
     ...
     * Sets downloadUrl
     *
     * @param string|null $downloadUrl The url to download payment details with.
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference The transfer reference.
     *
     * @return self
     */
     ...
     * Sets shopperEmail
     *
     * @param string|null $shopperEmail The e-mail of the shopper, included if an e-mail was sent to the shopper.
     *
     * @return self
     */
