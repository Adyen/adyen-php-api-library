...
/**
 * StandalonePaymentCancelResource Class Doc Comment
 *
 * @category Class
 ...
 */
class StandalonePaymentCancelResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StandalonePaymentCancelResource';
    ...
    */
     ...
     *
     * @param string $payment_reference The [`reference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__reqParam_reference) of the payment to cancel.
     *
     * @return self
     */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference Adyen's 16-character reference associated with the cancel request.
     *
     * @return self
     */
