...
/**
 * PaymentCancelResource Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentCancelResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentCancelResource';
    ...
    */
     ...
     *
     * @param string $payment_psp_reference The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment to cancel.
     *
     * @return self
     */
