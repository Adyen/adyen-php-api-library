...
/**
 * PaymentRefundResource Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentRefundResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRefundResource';
    ...
    protected static $setters = [
        ...
        'merchant_refund_reason' => 'setMerchantRefundReason',
    ...
    protected static $getters = [
        ...
        'merchant_refund_reason' => 'getMerchantRefundReason',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('merchant_refund_reason', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['merchant_refund_reason']) && !in_array($this->container['merchant_refund_reason'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'merchant_refund_reason', must be one of '%s'",
                $this->container['merchant_refund_reason'],
    ...
    /**
     * Sets merchant_refund_reason
     *
     * @param string|null $merchant_refund_reason Your reason for the refund request.
     *
     * @return self
     */
    public function setMerchantRefundReason($merchant_refund_reason)
    {
        if (is_null($merchant_refund_reason)) {
            throw new \InvalidArgumentException('non-nullable merchant_refund_reason cannot be null');
        }
        $allowedValues = $this->getMerchantRefundReasonAllowableValues();
        if (!in_array($merchant_refund_reason, $allowedValues, true)) {
        ...
        $this->container['merchant_refund_reason'] = $merchant_refund_reason;
     ...
     *
     * @param string $payment_psp_reference The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment to refund.
     *
     * @return self
     */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference Adyen's 16-character reference associated with the refund request.
     *
     * @return self
     */
