...
class AdditionalDataRetry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdditionalDataRetry';
    ...
    */
     ...
     * @return self
     */
    public function setRetryChainAttemptNumber($retryChainAttemptNumber): self
    {
     ...
     * @return self
     */
    public function setRetryOrderAttemptNumber($retryOrderAttemptNumber): self
    {
     ...
     * @return self
     */
    public function setRetrySkipRetry($retrySkipRetry): self
    {
