    ...
    */
    ...
    public function setApplePayToken($apple_pay_token)
    {
        ...
        if ((mb_strlen($apple_pay_token) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $apple_pay_token when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 10000.');
        }
    ...
    public function setEncryptedCardNumber($encrypted_card_number)
    {
        ...
        if ((mb_strlen($encrypted_card_number) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $encrypted_card_number when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 10000.');
        }
    ...
    public function setEncryptedExpiryMonth($encrypted_expiry_month)
    {
        ...
        if ((mb_strlen($encrypted_expiry_month) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $encrypted_expiry_month when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 10000.');
        }
    ...
    public function setEncryptedExpiryYear($encrypted_expiry_year)
    {
        ...
        if ((mb_strlen($encrypted_expiry_year) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $encrypted_expiry_year when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 10000.');
        }
    ...
    public function setEncryptedSecurityCode($encrypted_security_code)
    {
        ...
        if ((mb_strlen($encrypted_security_code) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $encrypted_security_code when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 10000.');
        }
    ...
    public function setThreeDs2SdkVersion($three_ds2_sdk_version)
    {
        ...
        if ((mb_strlen($three_ds2_sdk_version) > 12)) {
            throw new \InvalidArgumentException('invalid length for $three_ds2_sdk_version when calling PaymentDonationRequestPaymentMethod., must be smaller than or equal to 12.');
        }
