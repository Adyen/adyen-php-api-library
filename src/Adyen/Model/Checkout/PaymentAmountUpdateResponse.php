...
class PaymentAmountUpdateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentAmountUpdateResponse';
    ...
    */
     ...
     *
     * @param string|null $adjustAuthorisationData The data blob for subsequent synchronous adjust authorisation calls. Returned when the synchronous flow is used.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setPaymentPspReference($paymentPspReference): self
    {
     ...
     * Sets status
     *
     * @param string $status The status of your request.   If you included `adjustAuthorisationData` in your request, possible values are the following:   * **authorised**   * **refused**   Otherwise, the value is **received**.
     *
     * @return self
     */
