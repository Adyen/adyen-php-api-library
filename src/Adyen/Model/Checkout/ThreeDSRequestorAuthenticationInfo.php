...
class ThreeDSRequestorAuthenticationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ThreeDSRequestorAuthenticationInfo';
    ...
    */
     ...
     * @return self
     */
    public function setThreeDSReqAuthData($threeDSReqAuthData): self
    {
     ...
     * @return self
     */
    public function setThreeDSReqAuthMethod($threeDSReqAuthMethod): self
    {
     ...
     * @return self
     */
    public function setThreeDSReqAuthTimestamp($threeDSReqAuthTimestamp): self
    {
