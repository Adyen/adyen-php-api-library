...
/**
 * IdealDonations Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class IdealDonations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'IdealDonations';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'ideal');
    }
