...
/**
 * CheckoutCancelOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CheckoutCancelOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutCancelOrderRequest';
    ...
    */
     ...
     *
     * @param string $merchant_account The merchant account identifier that orderData belongs to.
     *
     * @return self
     */
