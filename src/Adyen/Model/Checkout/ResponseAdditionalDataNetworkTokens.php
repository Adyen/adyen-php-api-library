...
class ResponseAdditionalDataNetworkTokens implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ResponseAdditionalDataNetworkTokens';
    ...
    */
     ...
     * @return self
     */
    public function setNetworkTokenAvailable($networkTokenAvailable): self
    {
     ...
     * @return self
     */
    public function setNetworkTokenBin($networkTokenBin): self
    {
     ...
     * @return self
     */
    public function setNetworkTokenTokenSummary($networkTokenTokenSummary): self
    {
