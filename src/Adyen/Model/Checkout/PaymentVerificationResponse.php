...
class PaymentVerificationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'result_code' => 'string',
        'service_error' => '\Adyen\Model\Checkout\ServiceError2',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_error', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shopper_locale'] === null) {
            $invalidProperties[] = "'shopper_locale' can't be null";
        }
     ...
     *
     * @param string $merchant_reference A unique value that you provided in the initial `/paymentSession` request as a `reference` field.
     *
     * @return self
     */
    ...
    {
        return $this->container['service_error'];
    }

    /**
     * Sets service_error
     *
     * @param \Adyen\Model\Checkout\ServiceError2|null $service_error service_error
     *
     * @return self
     */
    public function setServiceError($service_error)
    {
        if (is_null($service_error)) {
            throw new \InvalidArgumentException('non-nullable service_error cannot be null');
        }
        $this->container['service_error'] = $service_error;
     ...
     * Sets shopper_locale
     *
     * @param string $shopper_locale The shopperLocale value provided in the payment request.
     *
     * @return self
     */
