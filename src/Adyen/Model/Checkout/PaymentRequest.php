    ...
    */
    ...
    public function setDeviceFingerprint($device_fingerprint)
    {
        ...
        if ((mb_strlen($device_fingerprint) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $device_fingerprint when calling PaymentRequest., must be smaller than or equal to 5000.');
        }
    ...
    public function setOrigin($origin)
    {
        ...
        if ((mb_strlen($origin) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $origin when calling PaymentRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling PaymentRequest., must be smaller than or equal to 8000.');
        }
    ...
    public function setStore($store)
    {
        ...
        if ((mb_strlen($store) > 16)) {
            throw new \InvalidArgumentException('invalid length for $store when calling PaymentRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($store) < 1)) {
            throw new \InvalidArgumentException('invalid length for $store when calling PaymentRequest., must be bigger than or equal to 1.');
        }
