...
class DetailsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payment_data']) && (mb_strlen($this->container['payment_data']) > 100000)) {
            $invalidProperties[] = "invalid value for 'payment_data', the character length must be smaller than or equal to 100000.";
        }
    ...
    public function setPaymentData($payment_data)
    {
        ...
        if ((mb_strlen($payment_data) > 100000)) {
            throw new \InvalidArgumentException('invalid length for $payment_data when calling DetailsRequest., must be smaller than or equal to 100000.');
        }
