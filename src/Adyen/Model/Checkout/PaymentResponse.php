...
class PaymentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentResponse';
    ...
    protected static array $openAPITypes = [
        'action' => '\Adyen\Model\Checkout\PaymentResponseAction',
    ...
    */
     ...
     * Gets action
     *
     * @return \Adyen\Model\Checkout\PaymentResponseAction|null
     */
     ...
     * Sets action
     *
     * @param \Adyen\Model\Checkout\PaymentResponseAction|null $action action
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setFraudResult($fraudResult): self
    {
     ...
     *
     * @param string|null $merchantReference The reference to uniquely identify a payment. This reference is used in all communication with you about the payment status. We recommend using a unique value per payment; however, it is not a requirement. If you need to provide multiple references for a transaction, separate them with hyphens (\"-\"). Maximum length: 80 characters.
     *
     * @return self
     */
     ...
     * @return self
     */
    public function setRefusalReason($refusalReason): self
    {
     ...
     * @return self
     */
    public function setRefusalReasonCode($refusalReasonCode): self
    {
     ...
     * @return self
     */
    public function setThreeDS2ResponseData($threeDS2ResponseData): self
    {
     ...
     * @return self
     */
    public function setThreeDS2Result($threeDS2Result): self
    {
     ...
     * @return self
     */
    public function setThreeDSPaymentData($threeDSPaymentData): self
    {
