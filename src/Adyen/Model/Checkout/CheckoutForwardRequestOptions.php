...
class CheckoutForwardRequestOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutForwardRequestOptions';
    ...
    */
     ...
     * @return self
     */
    public function setAccountUpdate($accountUpdate)
    {
     ...
     * @return self
     */
    public function setNetworkTxReferencePaths($networkTxReferencePaths)
    {
