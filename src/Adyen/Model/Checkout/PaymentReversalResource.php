...
/**
 * PaymentReversalResource Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentReversalResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentReversalResource';
    ...
    */
     ...
     *
     * @param string $payment_psp_reference The [`pspReference`](https://docs.adyen.com/api-explorer/#/CheckoutService/latest/post/payments__resParam_pspReference) of the payment to reverse.
     *
     * @return self
     */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference Adyen's 16-character reference associated with the reversal request.
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference Your reference for the reversal request.
     *
     * @return self
     */
