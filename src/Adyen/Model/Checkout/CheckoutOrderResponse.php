...
class CheckoutOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets expires_at
     *
     * @param string|null $expires_at The expiry date for the order.
     *
     * @return self
     */
     ...
     * Sets order_data
     *
     * @param string|null $order_data The encrypted order data.
     *
     * @return self
     */
     ...
     *
     * @param \Adyen\Model\Checkout\Amount|null $remaining_amount remaining_amount
     *
     * @return self
     */
