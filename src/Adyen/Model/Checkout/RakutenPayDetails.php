...
/**
 * RakutenPayDetails Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class RakutenPayDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RakutenPayDetails';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('type', $data ?? [], 'rakutenpay');
    }
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type **rakutenpay**
     *
     * @return self
     */
