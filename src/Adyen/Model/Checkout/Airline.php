...
class Airline implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Airline';
    ...
    */
     ...
     * Sets boardingFee
     *
     * @param int|null $boardingFee The amount charged for boarding the plane, in [minor units](https://docs.adyen.com/development-resources/currency-codes). * Encoding: Numeric * minLength: 1 character * maxLength: 11 characters * **additionalData key:** `airline.boarding_fee`
     *
     * @return self
     */
    public function setBoardingFee($boardingFee): self
    {
     ...
     *
     * @param string|null $computerizedReservationSystem The [CRS](https://en.wikipedia.org/wiki/Computer_reservation_system) used to make the reservation and purchase the ticket. * Encoding: ASCII * minLength: 4 characters * maxLength: 4 characters * **additionalData key:** `airline.computerized_reservation_system`
     *
     * @return self
     */
    public function setComputerizedReservationSystem($computerizedReservationSystem): self
    {
     ...
     *
     * @param string|null $customerReferenceNumber The alphanumeric customer reference number. * Encoding: ASCII * maxLength: 20 characters * If you send more than 20 characters, the customer reference number is truncated * Must not start with a space or be all spaces. * **additionalData key:** `airline.customer_reference_number`
     *
     * @return self
     */
     ...
     * Sets designatorCode
     *
     * @param string|null $designatorCode The [IATA](https://www.iata.org/services/pages/codes.aspx) 2-letter accounting code (PAX) that identifies the carrier. * Encoding: ASCII * Example: KLM = KL * minLength: 2 characters * maxLength: 2 characters * Must not start with a space or be all spaces. * **additionalData key:** `airline.airline_designator_code`
     *
     * @return self
     */
    public function setDesignatorCode($designatorCode): self
    {
     ...
     * Sets documentType
     *
     * @param string|null $documentType A code that identifies the type of item bought. The description of the code can appear on credit card statements. * Encoding: ASCII * Example: Passenger ticket = 01 * minLength: 2 characters * maxLength: 2 characters * **additionalData key:** `airline.document_type`
     *
     * @return self
     */
     ...
     * Sets flightDate
     *
     * @param \DateTime|null $flightDate The flight departure date. Time is optional. * Format for date only: `yyyy-MM-dd` * Format for date and time: `yyyy-MM-ddTHH:mm` * Use local time of departure airport. * minLength: 10 characters * maxLength: 16 characters * **additionalData key:** `airline.flight_date`
     *
     * @return self
     */
    public function setFlightDate($flightDate): self
    {
     ...
     * @return self
     */
    public function setPassengerName($passengerName): self
    {
     ...
     * @return self
     */
    public function setPassengers($passengers): self
    {
     ...
     * @return self
     */
    public function setTravelAgency($travelAgency): self
    {
