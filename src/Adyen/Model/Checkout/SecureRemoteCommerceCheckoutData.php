...
class SecureRemoteCommerceCheckoutData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($digitalCardId)) {
            throw new \InvalidArgumentException('non-nullable digitalCardId cannot be null');
        }
    ...
    public function setTokenReference($tokenReference)
    {
        if (is_null($tokenReference)) {
            throw new \InvalidArgumentException('non-nullable tokenReference cannot be null');
        }
