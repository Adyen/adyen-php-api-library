    ...
    */
    ...
    public function setAcctType($acct_type)
    {
        ...
        if ((mb_strlen($acct_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $acct_type when calling ThreeDS2RequestData., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($acct_type) < 2)) {
            throw new \InvalidArgumentException('invalid length for $acct_type when calling ThreeDS2RequestData., must be bigger than or equal to 2.');
        }
    ...
    public function setAddrMatch($addr_match)
    {
        ...
        if ((mb_strlen($addr_match) > 1)) {
            throw new \InvalidArgumentException('invalid length for $addr_match when calling ThreeDS2RequestData., must be smaller than or equal to 1.');
        }
        if ((mb_strlen($addr_match) < 1)) {
            throw new \InvalidArgumentException('invalid length for $addr_match when calling ThreeDS2RequestData., must be bigger than or equal to 1.');
        }
    ...
    public function setPurchaseInstalData($purchase_instal_data)
    {
        ...
        if ((mb_strlen($purchase_instal_data) > 3)) {
            throw new \InvalidArgumentException('invalid length for $purchase_instal_data when calling ThreeDS2RequestData., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($purchase_instal_data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $purchase_instal_data when calling ThreeDS2RequestData., must be bigger than or equal to 1.');
        }
    ...
    public function setRecurringFrequency($recurring_frequency)
    {
        ...
        if ((mb_strlen($recurring_frequency) > 4)) {
            throw new \InvalidArgumentException('invalid length for $recurring_frequency when calling ThreeDS2RequestData., must be smaller than or equal to 4.');
        }
    ...
    public function setTransType($trans_type)
    {
        ...
        if ((mb_strlen($trans_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $trans_type when calling ThreeDS2RequestData., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($trans_type) < 2)) {
            throw new \InvalidArgumentException('invalid length for $trans_type when calling ThreeDS2RequestData., must be bigger than or equal to 2.');
        }
