...
class KlarnaDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KlarnaDetails';
    ...
    */
     ...
     * Sets merchantData
     *
     * @param string|null $merchantData Base64-encoded merchant metadata (Extra Merchant Data) forwarded to Klarna at authorization.
     *
     * @return self
     */
