...
/**
 * PaymentMethodUPIApps Class Doc Comment
 *
 * @package  Adyen\Model\Checkout
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodUPIApps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentMethodUPIApps';
    ...
    */
     ...
     * @return self
     */
    public function setAppIdentifierInfo($appIdentifierInfo): self
    {
     ...
     * Sets id
     *
     * @param string $id The unique identifier of this app, to submit in requests to /payments.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A localized name of the app.
     *
     * @return self
     */
