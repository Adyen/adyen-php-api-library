...
class RestServiceError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'errorCode' => 'string',
        'instance' => 'string',
        'invalidFields' => '\Adyen\Model\Capital\InvalidField[]',
        'requestId' => 'string',
        'response' => '\Adyen\Model\Capital\JSONObject',
        'status' => 'int',
        'title' => 'string',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Gets invalidFields
     *
     * @return \Adyen\Model\Capital\InvalidField[]|null
     */
     ...
     * Sets invalidFields
     *
     * @param \Adyen\Model\Capital\InvalidField[]|null $invalidFields Detailed explanation of each validation error, when applicable.
     *
     * @return self
     */
     ...
     * Gets response
     *
     * @return \Adyen\Model\Capital\JSONObject|null
     */
     ...
     * Sets response
     *
     * @param \Adyen\Model\Capital\JSONObject|null $response response
     *
     * @return self
     */
