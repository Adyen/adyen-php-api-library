...
class Action implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('actionCode', $data ?? [], null);
    ...
    */
     ...
     * Sets actionCode
     *
     * @param string $actionCode The code identifying the action that needs to be completed.
     *
     * @return self
     */
     ...
     * Sets resolved
     *
     * @param bool $resolved Indicates whether this action has been successfully completed.
     *
     * @return self
     */
