...
/**
 * DisbursementRepayment Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class DisbursementRepayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisbursementRepayment';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['updateDescription'] === null) {
            $invalidProperties[] = "'updateDescription' can't be null";
        }
