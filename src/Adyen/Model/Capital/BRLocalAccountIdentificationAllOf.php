...
/**
 * BRLocalAccountIdentificationAllOf Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class BRLocalAccountIdentificationAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BRLocalAccountIdentification_allOf';
    ...
    */
     ...
     * Sets bankCode
     *
     * @param string|null $bankCode The 3-digit bank code, with leading zeros.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type **brLocal**
     *
     * @return self
     */
