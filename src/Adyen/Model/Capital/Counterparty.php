...
class Counterparty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $accountHolderId The unique identifier of the account holder that receives the grant. If no `balanceAccountId` is provided, the grant funds are disbursed to the primary balance account of this account holder.
     *
     * @return self
     */
     ...
     *
     * @param string|null $balanceAccountId The unique identifier of the balance account where the funds are disbursed. The balance account must belong to the specified account holder.
     *
     * @return self
     */
     ...
     *
     * @param string|null $transferInstrumentId The unique identifier of the transfer instrument where the funds are disbursed. The transfer instrument must belong to the legal entity of the specified account holder.
     *
     * @return self
     */
