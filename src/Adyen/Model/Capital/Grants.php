...
/**
 * Grants Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class Grants implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'grants' => '\Adyen\Model\Capital\Grant[]'
    ];
    ...
    */
     ...
     * Sets grants
     *
     * @param \Adyen\Model\Capital\Grant[] $grants Contains a list of the grants that the account holder has received.
     *
     * @return self
     */
