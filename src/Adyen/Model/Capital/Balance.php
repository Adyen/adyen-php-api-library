...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets fee
     *
     * @param int $fee The amount of the grant fee.
     *
     * @return self
     */
     ...
     * Sets principal
     *
     * @param int $principal The grant amount that is paid out to the user for business financing.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int $total The total amount of the grant that the user must repay. It is the sum of the fee amount and the principal amount.
     *
     * @return self
     */
