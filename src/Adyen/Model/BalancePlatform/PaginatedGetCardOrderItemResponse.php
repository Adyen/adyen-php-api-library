...
/**
 * PaginatedGetCardOrderItemResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaginatedGetCardOrderItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedGetCardOrderItemResponse';
    ...
    protected static $openAPITypes = [
        'data' => '\Adyen\Model\BalancePlatform\CardOrderItem[]',
        'hasNext' => 'bool',
        'hasPrevious' => 'bool'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Adyen\Model\BalancePlatform\CardOrderItem[]
     */
     ...
     * Sets data
     *
     * @param \Adyen\Model\BalancePlatform\CardOrderItem[] $data List of card order items in the card order batch.
     *
     * @return self
     */
