...
class PhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PHONE_TYPE_LANDLINE = 'Landline';
    public const PHONE_TYPE_MOBILE = 'Mobile';
    public const PHONE_TYPE_SIP = 'SIP';
    ...
    */
     ...
     *
     * @param string|null $phoneCountryCode The two-character ISO-3166-1 alpha-2 country code of the phone number. For example, **US** or **NL**.
     *
     * @return self
     */
     ...
     * Sets phoneNumber
     *
     * @param string|null $phoneNumber The phone number. The inclusion of the phone number country code is not necessary.
     *
     * @return self
     */
     ...
     * Sets phoneType
     *
     * @param string|null $phoneType The type of the phone number. Possible values: **Landline**, **Mobile**, **SIP**, **Fax**.
     *
     * @return self
     */
