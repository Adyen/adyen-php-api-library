...
class PhoneNumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $phone_country_code The two-character ISO-3166-1 alpha-2 country code of the phone number. For example, **US** or **NL**.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number The phone number. The inclusion of the phone number country code is not necessary.
     *
     * @return self
     */
     ...
     * Sets phone_type
     *
     * @param string|null $phone_type The type of the phone number. Possible values: **Landline**, **Mobile**, **SIP**, **Fax**.
     *
     * @return self
     */
