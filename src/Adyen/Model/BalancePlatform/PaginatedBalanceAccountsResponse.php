...
class PaginatedBalanceAccountsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'balance_accounts' => '\Adyen\Model\BalancePlatform\BalanceAccount[]',
        'has_next' => 'bool',
        'has_previous' => 'bool'
    ];
    ...
    protected static $setters = [
        'balance_accounts' => 'setBalanceAccounts',
        'has_next' => 'setHasNext',
    ...
    protected static $getters = [
        'balance_accounts' => 'getBalanceAccounts',
        'has_next' => 'getHasNext',
    ...
    {
        $this->setIfExists('balance_accounts', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['balance_accounts'] === null) {
            $invalidProperties[] = "'balance_accounts' can't be null";
        }
    ...
    /**
     * Gets balance_accounts
     *
     * @return \Adyen\Model\BalancePlatform\BalanceAccount[]
     */
    public function getBalanceAccounts()
    {
        return $this->container['balance_accounts'];
    }

    /**
     * Sets balance_accounts
     *
     * @param \Adyen\Model\BalancePlatform\BalanceAccount[] $balance_accounts List of balance accounts.
     *
     * @return self
     */
    public function setBalanceAccounts($balance_accounts)
    {
        if (is_null($balance_accounts)) {
            throw new \InvalidArgumentException('non-nullable balance_accounts cannot be null');
        }
        $this->container['balance_accounts'] = $balance_accounts;
