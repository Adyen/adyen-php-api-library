...
/**
 * PinChangeRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PinChangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PinChangeRequest';
    ...
    protected static $getters = [
        ...
        'encryptedPinBlock' => 'getEncryptedPinBlock',
    ...
    {
        $this->setIfExists('encryptedKey', $data ?? [], null);
        $this->setIfExists('encryptedPinBlock', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['encryptedKey'] === null) {
            $invalidProperties[] = "'encryptedKey' can't be null";
        }
        if ($this->container['encryptedPinBlock'] === null) {
            $invalidProperties[] = "'encryptedPinBlock' can't be null";
        }
    ...
    /**
     * Gets encryptedPinBlock
     *
     * @return string
     */
    public function getEncryptedPinBlock()
    {
        return $this->container['encryptedPinBlock'];
    }
