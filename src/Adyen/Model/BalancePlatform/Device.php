...
class Device implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the SCA device.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the SCA device. You can show this name to your user to help them identify the device.
     *
     * @return self
     */
     ...
     *
     * @param string|null $paymentInstrumentId The unique identifier of the payment instrument that is associated with the SCA device.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of device.  Possible values: **ios**, **android**, **browser**.
     *
     * @return self
     */
