...
/**
 * RegisterSCARequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class RegisterSCARequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterSCARequest';
    ...
    */
     ...
     *
     * @param string $paymentInstrumentId The unique identifier of the payment instrument for which you are registering the SCA device.
     *
     * @return self
     */
     ...
     *
     * @return \Adyen\Model\BalancePlatform\DelegatedAuthenticationData
     */
     ...
     *
     * @param \Adyen\Model\BalancePlatform\DelegatedAuthenticationData $strongCustomerAuthentication strongCustomerAuthentication
     *
     * @return self
     */
