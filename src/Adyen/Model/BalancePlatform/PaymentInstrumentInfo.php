...
/**
 * PaymentInstrumentInfo Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentInstrumentInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentInstrumentInfo';
    ...
    protected static $openAPITypes = [
        ...
        'payment_instrument_group_id' => 'string',
        'reference' => 'string',
        'status' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'payment_instrument_group_id' => null,
        'reference' => null,
        'status' => null,
        'status_reason' => null,
        'type' => null
    ...
    protected static $openAPINullables = [
		...
		'card' => false,
		'description' => false,
		'issuing_country_code' => false,
		'payment_instrument_group_id' => false,
		'reference' => false,
		'status' => false,
		'status_reason' => false,
		'type' => false
    ...
    protected static $setters = [
        ...
        'payment_instrument_group_id' => 'setPaymentInstrumentGroupId',
    ...
    protected static $getters = [
        ...
        'payment_instrument_group_id' => 'getPaymentInstrumentGroupId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payment_instrument_group_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string $balance_account_id The unique identifier of the [balance account](https://docs.adyen.com/api-explorer/#/balanceplatform/v1/post/balanceAccounts__resParam_id) associated with the payment instrument.
     *
     * @return self
     */
     ...
     *
     * @param string $issuing_country_code The two-character [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code where the payment instrument is issued. For example, **NL** or **US**.
     *
     * @return self
     */
    public function setIssuingCountryCode($issuing_country_code)
    {
        if (is_null($issuing_country_code)) {
            throw new \InvalidArgumentException('non-nullable issuing_country_code cannot be null');
        }
    ...
    /**
     * Gets payment_instrument_group_id
     *
     * @return string|null
     */
    ...
    /**
     * Sets payment_instrument_group_id
     *
     * @param string|null $payment_instrument_group_id The unique identifier of the [payment instrument group](https://docs.adyen.com/api-explorer/#/balanceplatform/v1/post/paymentInstrumentGroups__resParam_id) to which the payment instrument belongs.
     *
     * @return self
     */
    public function setPaymentInstrumentGroupId($payment_instrument_group_id)
    {
        if (is_null($payment_instrument_group_id)) {
            throw new \InvalidArgumentException('non-nullable payment_instrument_group_id cannot be null');
        }
        $this->container['payment_instrument_group_id'] = $payment_instrument_group_id;
