...
/**
 * PaginatedGetCardOrderResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaginatedGetCardOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedGetCardOrderResponse';
    ...
    protected static $openAPITypes = [
        'cardOrders' => '\Adyen\Model\BalancePlatform\CardOrder[]',
        'hasNext' => 'bool',
        'hasPrevious' => 'bool'
    ];
    ...
    {
        $this->setIfExists('cardOrders', $data ?? [], null);
    ...
    */
     ...
     * Gets cardOrders
     *
     * @return \Adyen\Model\BalancePlatform\CardOrder[]|null
     */
    public function getCardOrders()
    {
        return $this->container['cardOrders'];
    }

    /**
     * Sets cardOrders
     *
     * @param \Adyen\Model\BalancePlatform\CardOrder[]|null $cardOrders Contains objects with information about card orders.
     *
     * @return self
     */
