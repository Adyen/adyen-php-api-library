...
class PaginatedPaymentInstrumentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'has_next' => 'bool',
        'has_previous' => 'bool',
        'payment_instruments' => '\Adyen\Model\BalancePlatform\PaymentInstrument[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payment_instruments', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_instruments'] === null) {
            $invalidProperties[] = "'payment_instruments' can't be null";
        }
     ...
     *
     * @param \Adyen\Model\BalancePlatform\PaymentInstrument[] $payment_instruments List of payment instruments associated with the balance account.
     *
     * @return self
     */
    public function setPaymentInstruments($payment_instruments)
    {
        if (is_null($payment_instruments)) {
            throw new \InvalidArgumentException('non-nullable payment_instruments cannot be null');
        }
