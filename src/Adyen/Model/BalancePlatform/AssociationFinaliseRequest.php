...
class AssociationFinaliseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssociationFinaliseRequest';
    ...
    protected static $openAPITypes = [
        'ids' => 'string[]',
        'strongCustomerAuthentication' => '\Adyen\Model\BalancePlatform\AssociationDelegatedAuthenticationData',
        'type' => 'string'
    ];
    ...
    public const TYPE_PAYMENT_INSTRUMENT = 'PaymentInstrument';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['strongCustomerAuthentication'] === null) {
            $invalidProperties[] = "'strongCustomerAuthentication' can't be null";
        }
     ...
     * Sets ids
     *
     * @param string[] $ids The list of unique identifiers of the resources that you are associating with the SCA device.  Maximum: 5 strings.
     *
     * @return self
     */
    ...
    /**
     * Gets strongCustomerAuthentication
     *
    ...
    /**
     * Sets strongCustomerAuthentication
     *
     * @param \Adyen\Model\BalancePlatform\AssociationDelegatedAuthenticationData $strongCustomerAuthentication strongCustomerAuthentication
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of resource that you are associating with the SCA device.  Possible value: **PaymentInstrument**
     *
     * @return self
     */
