...
/**
 * BalanceAccountConfigurationRequest Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class BalanceAccountConfigurationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BalanceAccountConfigurationRequest';
    ...
    */
     ...
     *
     * @param string $balancePlatformPayoutScheduleId The unique identifier of the payout schedule that is applied to the balance account.
     *
     * @return self
     */
     ...
     * Sets frequency
     *
     * @param string $frequency The frequency of payouts initiated by this payout schedule.  Possible values: * daily * weekdays * weekly * monthly  Default value: The `defaultFrequency` from the balance platform schedule that you are applying.
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference The merchant reference that will be shown only in the schedule.
     *
     * @return self
     */
