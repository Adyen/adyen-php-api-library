...
/**
 * RegisterSCAResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class RegisterSCAResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterSCAResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the SCA device you are registering.
     *
     * @return self
     */
     ...
     *
     * @param string|null $paymentInstrumentId The unique identifier of the payment instrument for which you are registering the SCA device.
     *
     * @return self
     */
     ...
     * Sets success
     *
     * @param bool|null $success Specifies if the registration was initiated successfully.
     *
     * @return self
     */
