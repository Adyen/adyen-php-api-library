...
class BulkAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $house_number_or_name The house number or name.
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The postal code.  Maximum length:  * 5 digits for addresses in the US.  * 10 characters for all other countries.
     *
     * @return self
     */
     ...
     *
     * @param string|null $state_or_province The two-letter ISO 3166-2 state or province code.  Maximum length: 2 characters for addresses in the US.
     *
     * @return self
     */
