...
class PaginatedAccountHoldersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'accountHolders' => '\Adyen\Model\BalancePlatform\AccountHolder[]',
        'hasNext' => 'bool',
        'hasPrevious' => 'bool'
    ];
    ...
    protected static $setters = [
        'accountHolders' => 'setAccountHolders',
        'hasNext' => 'setHasNext',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountHolders'] === null) {
            $invalidProperties[] = "'accountHolders' can't be null";
        }
    ...
    {
        return $this->container['accountHolders'];
    }

    /**
     * Sets accountHolders
     *
     * @param \Adyen\Model\BalancePlatform\AccountHolder[] $accountHolders List of account holders.
     *
     * @return self
     */
