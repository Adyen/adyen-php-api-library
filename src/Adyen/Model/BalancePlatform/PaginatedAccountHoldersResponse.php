...
/**
 * PaginatedAccountHoldersResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaginatedAccountHoldersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedAccountHoldersResponse';
    ...
    protected static $openAPITypes = [
        'account_holders' => '\Adyen\Model\BalancePlatform\AccountHolder[]',
        'has_next' => 'bool',
        'has_previous' => 'bool'
    ];
    ...
    protected static $setters = [
        'account_holders' => 'setAccountHolders',
        'has_next' => 'setHasNext',
    ...
    protected static $getters = [
        'account_holders' => 'getAccountHolders',
        'has_next' => 'getHasNext',
    ...
    {
        $this->setIfExists('account_holders', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_holders'] === null) {
            $invalidProperties[] = "'account_holders' can't be null";
        }
    ...
    /**
     * Gets account_holders
     *
     * @return \Adyen\Model\BalancePlatform\AccountHolder[]
     */
    public function getAccountHolders()
    {
        return $this->container['account_holders'];
    }

    /**
     * Sets account_holders
     *
     * @param \Adyen\Model\BalancePlatform\AccountHolder[] $account_holders List of account holders.
     *
     * @return self
     */
    public function setAccountHolders($account_holders)
    {
        if (is_null($account_holders)) {
            throw new \InvalidArgumentException('non-nullable account_holders cannot be null');
        }
        $this->container['account_holders'] = $account_holders;
