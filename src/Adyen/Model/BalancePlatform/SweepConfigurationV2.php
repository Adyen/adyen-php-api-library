...
class SweepConfigurationV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'sweep_amount' => '\Adyen\Model\BalancePlatform\Amount',
        'target_amount' => '\Adyen\Model\BalancePlatform\Amount',
        'trigger_amount' => '\Adyen\Model\BalancePlatform\Amount',
        'type' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trigger_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets sweep_amount
     *
     * @param \Adyen\Model\BalancePlatform\Amount|null $sweep_amount sweep_amount
     *
     * @return self
     */
     ...
     * Sets target_amount
     *
     * @param \Adyen\Model\BalancePlatform\Amount|null $target_amount target_amount
     *
     * @return self
     */
     ...
     * Sets trigger_amount
     *
     * @param \Adyen\Model\BalancePlatform\Amount|null $trigger_amount trigger_amount
     *
     * @return self
     */
    public function setTriggerAmount($trigger_amount)
    {
        if (is_null($trigger_amount)) {
            throw new \InvalidArgumentException('non-nullable trigger_amount cannot be null');
        }
