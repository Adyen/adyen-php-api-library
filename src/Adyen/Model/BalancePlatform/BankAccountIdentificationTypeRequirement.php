...
class BankAccountIdentificationTypeRequirement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const BANK_ACCOUNT_IDENTIFICATION_TYPES_IN_LOCAL = 'inLocal';
    public const BANK_ACCOUNT_IDENTIFICATION_TYPES_JP_LOCAL = 'jpLocal';
    public const BANK_ACCOUNT_IDENTIFICATION_TYPES_LEGACY = 'legacy';
    public const BANK_ACCOUNT_IDENTIFICATION_TYPES_MX_LOCAL = 'mxLocal';
    public const BANK_ACCOUNT_IDENTIFICATION_TYPES_MY_LOCAL = 'myLocal';
    ...
    public function getBankAccountIdentificationTypesAllowableValues()
    {
        return [
            ...
            self::BANK_ACCOUNT_IDENTIFICATION_TYPES_IN_LOCAL,
            self::BANK_ACCOUNT_IDENTIFICATION_TYPES_JP_LOCAL,
            self::BANK_ACCOUNT_IDENTIFICATION_TYPES_LEGACY,
            self::BANK_ACCOUNT_IDENTIFICATION_TYPES_MX_LOCAL,
            self::BANK_ACCOUNT_IDENTIFICATION_TYPES_MY_LOCAL,
