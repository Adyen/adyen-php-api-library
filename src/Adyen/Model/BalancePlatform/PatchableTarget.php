...
/**
 * PatchableTarget Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PatchableTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchableTarget';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the `target.type`. This can be the ID of your:  * balance platform * account holder * account holder's balance account
     *
     * @return self
     */
