...
class TransferEventEventsDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransferEvent_eventsData_inner';
    ...
    */
     ...
     * @return self
     */
    public function setInterchangeAmount($interchangeAmount): self
    {
     ...
     * @return self
     */
    public function setInterchangeRateIndicator($interchangeRateIndicator): self
    {
     ...
     * @return self
     */
    public function setCaptureCycleId($captureCycleId): self
    {
