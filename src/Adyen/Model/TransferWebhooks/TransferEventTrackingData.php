...
class TransferEventTrackingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransferEvent_trackingData';
    ...
    public const TYPE_ESTIMATION = 'estimation';
    public const TYPE_INTERNAL_REVIEW = 'internalReview';
    public const REASON_REFUSED_FOR_REGULATORY_REASONS = 'refusedForRegulatoryReasons';
    ...
    {
        return [
            self::REASON_REFUSED_FOR_REGULATORY_REASONS,
        ];
    }
