...
class TransferEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets schemeTraceID
     *
     * @param string|null $schemeTraceID SchemeTraceID retrieved from scheme.
     *
     * @return self
     */
     ...
     *
     * @param string|null $schemeUniqueTransactionID SchemeUniqueTransactionID retrieved from scheme.
     *
     * @return self
     */
