...
/**
 * TransferEventTracingData Class Doc Comment
 *
 * @description Additional tracing information for the tracing event.
 * @package  Adyen\Model\TransferWebhooks
 * @implements \ArrayAccess<string, mixed>
 */
class TransferEventTracingData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransferEvent_tracingData';
    ...
    public const TYPE_US_ACH = 'usAch';
    ...
    */
     ...
     * @return self
     */
    public function setFpid($fpid): self
    {
     ...
     * @return self
     */
    public function setTraceNumber($traceNumber): self
    {
