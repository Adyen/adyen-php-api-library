...
/**
 * TransferNotificationTransferTracking Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class TransferNotificationTransferTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferNotificationTransferTracking';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The tracking status of the transfer.
     *
     * @return self
     */
