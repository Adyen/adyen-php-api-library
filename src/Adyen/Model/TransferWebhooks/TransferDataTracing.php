 ...
 *
 * @description Contains information for tracing the transfer after Adyen forwards it to the network.
...
class TransferDataTracing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TransferData_tracing';
