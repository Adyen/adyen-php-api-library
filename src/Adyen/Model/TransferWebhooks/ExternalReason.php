...
/**
 * ExternalReason Class Doc Comment
 *
 * @package  Adyen\Model\TransferWebhooks
 * @implements \ArrayAccess<string, mixed>
 */
class ExternalReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExternalReason';
