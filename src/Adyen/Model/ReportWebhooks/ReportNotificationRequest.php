...
class ReportNotificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportNotificationRequest';
    ...
    protected static $openAPITypes = [
        'data' => '\Adyen\Model\ReportWebhooks\ReportNotificationData',
        'environment' => 'string',
        'type' => 'string'
    ];
    ...
    public const TYPE_BALANCE_PLATFORM_REPORT_CREATED = 'balancePlatform.report.created';
    ...
    {
        return [
            self::TYPE_BALANCE_PLATFORM_REPORT_CREATED,
        ];
    }
    /**
    ...
    */
     ...
     * Gets data
     *
     * @return \Adyen\Model\ReportWebhooks\ReportNotificationData
     */
     ...
     * Sets data
     *
     * @param \Adyen\Model\ReportWebhooks\ReportNotificationData $data data
     *
     * @return self
     */
