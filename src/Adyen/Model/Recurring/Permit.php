...
class Permit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $getters = [
        ...
        'validTillDate' => 'getValidTillDate'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('resultKey', $data ?? [], null);
        $this->setIfExists('validTillDate', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets partnerId
     *
     * @param string|null $partnerId Partner ID (when using the permit-per-partner token sharing model).
     *
     * @return self
     */
     ...
     *
     * @param string|null $profileReference The profile to apply to this permit (when using the shared permits model).
     *
     * @return self
     */
    ...
    {
        return $this->container['resultKey'];
    }

    /**
     * Sets resultKey
     *
     * @param string|null $resultKey The key to link permit requests to permit results.
     *
     * @return self
     */
    ...
    {
        return $this->container['validTillDate'];
    }

    /**
     * Sets validTillDate
     *
     * @param \DateTime|null $validTillDate The expiry date for this permit.
     *
     * @return self
     */
