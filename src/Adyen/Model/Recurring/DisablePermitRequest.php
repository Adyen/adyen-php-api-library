...
/**
 * DisablePermitRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class DisablePermitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisablePermitRequest';
    ...
    */
     ...
     * Sets token
     *
     * @param string $token The permit token to disable.
     *
     * @return self
     */
