...
class ScheduleAccountUpdaterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $merchantAccount Account of the merchant.
     *
     * @return self
     */
     ...
     *
     * @param string|null $selectedRecurringDetailReference The selected detail recurring reference.  Optional if `card` is provided.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shopperReference The reference of the shopper that owns the recurring contract.  Optional if `card` is provided.
     *
     * @return self
     */
