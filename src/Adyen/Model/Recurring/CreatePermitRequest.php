...
class CreatePermitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $recurring_detail_reference The recurring contract the new permits will use.
     *
     * @return self
     */
     ...
     *
     * @param string $shopper_reference The shopper's reference to uniquely identify this shopper (e.g. user ID or account ID).
     *
     * @return self
     */
