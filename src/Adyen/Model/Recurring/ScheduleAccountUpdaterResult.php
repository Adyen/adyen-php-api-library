...
class ScheduleAccountUpdaterResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScheduleAccountUpdaterResult';
    ...
    */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference Adyen's 16-character unique reference associated with the transaction. This value is globally unique; quote it when communicating with us about this request.
     *
     * @return self
     */
     ...
     * Sets result
     *
     * @param string $result The result of scheduling an Account Updater. If scheduling was successful, this field returns **Success**; otherwise it contains the error message.
     *
     * @return self
     */
