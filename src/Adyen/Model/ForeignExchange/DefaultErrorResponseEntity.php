...
class DefaultErrorResponseEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'errorCode' => 'string',
        'instance' => 'string',
        'invalidFields' => '\Adyen\Model\ForeignExchange\InvalidField[]',
        'requestId' => 'string',
        'status' => 'int',
        'title' => 'string',
        'type' => 'string'
    ...
    */
     ...
     * Gets invalidFields
     *
     * @return \Adyen\Model\ForeignExchange\InvalidField[]|null
     */
     ...
     * Sets invalidFields
     *
     * @param \Adyen\Model\ForeignExchange\InvalidField[]|null $invalidFields Array of fields with validation errors when applicable.
     *
     * @return self
     */
