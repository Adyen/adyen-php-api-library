...
/**
 * TransferViewCategoryData Class Doc Comment
 *
 * @category Class
...
class TransferViewCategoryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferView_categoryData';
    ...
    */
     ...
     *
     * @return \Adyen\Model\TransactionWebhooks\RelayedAuthorisationData|null
     */
     ...
     *
     * @param \Adyen\Model\TransactionWebhooks\RelayedAuthorisationData|null $relayedAuthorisationData relayedAuthorisationData
     *
     * @return self
     */
     ...
     *
     * @return \Adyen\Model\TransactionWebhooks\TransferNotificationValidationFact[]|null
     */
     ...
     *
     * @param \Adyen\Model\TransactionWebhooks\TransferNotificationValidationFact[]|null $validationFacts The evaluation of the validation facts. See [validation checks](https://docs.adyen.com/issuing/validation-checks) for more information.
     *
     * @return self
     */
