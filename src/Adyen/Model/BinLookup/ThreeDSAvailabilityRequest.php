...
class ThreeDSAvailabilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ThreeDSAvailabilityRequest';
    ...
    */
     ...
     * Sets additionalData
     *
     * @param array<string,string>|null $additionalData This field contains additional data, which may be required for a particular request.  The `additionalData` object consists of entries, each of which includes the key and value.
     *
     * @return self
     */
     ...
     * Sets cardNumber
     *
     * @param string|null $cardNumber Card number or BIN.
     *
     * @return self
     */
     ...
     *
     * @param string $merchantAccount The merchant account identifier.
     *
     * @return self
     */
     ...
     *
     * @param string|null $recurringDetailReference A recurring detail reference corresponding to a card.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shopperReference The shopper's reference to uniquely identify this shopper (e.g. user ID or account ID).
     *
     * @return self
     */
