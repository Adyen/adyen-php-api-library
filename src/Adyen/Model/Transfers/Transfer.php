...
class Transfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['reference']) && (mb_strlen($this->container['reference']) > 80)) {
            $invalidProperties[] = "invalid value for 'reference', the character length must be smaller than or equal to 80.";
        }

        if (!is_null($this->container['reference_for_beneficiary']) && (mb_strlen($this->container['reference_for_beneficiary']) > 80)) {
            $invalidProperties[] = "invalid value for 'reference_for_beneficiary', the character length must be smaller than or equal to 80.";
        }
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 80)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling Transfer., must be smaller than or equal to 80.');
        }
    ...
    public function setReferenceForBeneficiary($reference_for_beneficiary)
    {
        ...
        if ((mb_strlen($reference_for_beneficiary) > 80)) {
            throw new \InvalidArgumentException('invalid length for $reference_for_beneficiary when calling Transfer., must be smaller than or equal to 80.');
        }
