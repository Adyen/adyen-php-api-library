...
class JSONObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'paths' => '\Adyen\Model\Transfers\JSONPath[]',
        'root_path' => '\Adyen\Model\Transfers\JSONPath'
    ];
    ...
    */
     ...
     * Gets paths
     *
     * @return \Adyen\Model\Transfers\JSONPath[]|null
     */
     ...
     * Sets paths
     *
     * @param \Adyen\Model\Transfers\JSONPath[]|null $paths paths
     *
     * @return self
     */
     ...
     * Sets root_path
     *
     * @param \Adyen\Model\Transfers\JSONPath|null $root_path root_path
     *
     * @return self
     */
    public function setRootPath($root_path)
    {
        if (is_null($root_path)) {
            throw new \InvalidArgumentException('non-nullable root_path cannot be null');
        }
