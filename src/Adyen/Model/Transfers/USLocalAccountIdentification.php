    ...
    */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling USLocalAccountIdentification., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($account_number) < 2)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling USLocalAccountIdentification., must be bigger than or equal to 2.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling USLocalAccountIdentification., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($routing_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling USLocalAccountIdentification., must be bigger than or equal to 9.');
        }
