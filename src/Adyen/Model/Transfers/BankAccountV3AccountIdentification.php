...
class BankAccountV3AccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 18)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 18.";
        }

        if ((mb_strlen($this->container['account_number']) < 2)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be bigger than or equal to 2.";
        }

        if ($this->container['bsb_code'] === null) {
            $invalidProperties[] = "'bsb_code' can't be null";
        }
        if ((mb_strlen($this->container['bsb_code']) > 6)) {
            $invalidProperties[] = "invalid value for 'bsb_code', the character length must be smaller than or equal to 6.";
        }

        if ((mb_strlen($this->container['bsb_code']) < 6)) {
            $invalidProperties[] = "invalid value for 'bsb_code', the character length must be bigger than or equal to 6.";
        }
        ...
        if ((mb_strlen($this->container['branch_number']) > 4)) {
            $invalidProperties[] = "invalid value for 'branch_number', the character length must be smaller than or equal to 4.";
        }

        if ((mb_strlen($this->container['branch_number']) < 1)) {
            $invalidProperties[] = "invalid value for 'branch_number', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['institution_number'] === null) {
            $invalidProperties[] = "'institution_number' can't be null";
        }
        if ((mb_strlen($this->container['institution_number']) > 3)) {
            $invalidProperties[] = "invalid value for 'institution_number', the character length must be smaller than or equal to 3.";
        }

        if ((mb_strlen($this->container['institution_number']) < 3)) {
            $invalidProperties[] = "invalid value for 'institution_number', the character length must be bigger than or equal to 3.";
        }

        if ($this->container['transit_number'] === null) {
            $invalidProperties[] = "'transit_number' can't be null";
        }
        if ((mb_strlen($this->container['transit_number']) > 5)) {
            $invalidProperties[] = "invalid value for 'transit_number', the character length must be smaller than or equal to 5.";
        }

        if ((mb_strlen($this->container['transit_number']) < 5)) {
            $invalidProperties[] = "invalid value for 'transit_number', the character length must be bigger than or equal to 5.";
        }
        ...
        if ((mb_strlen($this->container['clearing_number']) > 5)) {
            $invalidProperties[] = "invalid value for 'clearing_number', the character length must be smaller than or equal to 5.";
        }

        if ((mb_strlen($this->container['clearing_number']) < 4)) {
            $invalidProperties[] = "invalid value for 'clearing_number', the character length must be bigger than or equal to 4.";
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 18.');
        }
        if ((mb_strlen($account_number) < 2)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 2.');
        }
    ...
    public function setBsbCode($bsb_code)
    {
        ...
        if ((mb_strlen($bsb_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $bsb_code when calling BankAccountV3AccountIdentification., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($bsb_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $bsb_code when calling BankAccountV3AccountIdentification., must be bigger than or equal to 6.');
        }
    ...
    public function setBankCode($bank_code)
    {
        ...
        if ((mb_strlen($bank_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $bank_code when calling BankAccountV3AccountIdentification., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($bank_code) < 4)) {
            throw new \InvalidArgumentException('invalid length for $bank_code when calling BankAccountV3AccountIdentification., must be bigger than or equal to 4.');
        }
    ...
    public function setBranchNumber($branch_number)
    {
        ...
        if ((mb_strlen($branch_number) > 4)) {
            throw new \InvalidArgumentException('invalid length for $branch_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($branch_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $branch_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 1.');
        }
    ...
    public function setInstitutionNumber($institution_number)
    {
        ...
        if ((mb_strlen($institution_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $institution_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($institution_number) < 3)) {
            throw new \InvalidArgumentException('invalid length for $institution_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 3.');
        }
    ...
    public function setTransitNumber($transit_number)
    {
        ...
        if ((mb_strlen($transit_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transit_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($transit_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $transit_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 5.');
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling BankAccountV3AccountIdentification., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling BankAccountV3AccountIdentification., must be bigger than or equal to 8.');
        }
    ...
    public function setClearingNumber($clearing_number)
    {
        ...
        if ((mb_strlen($clearing_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $clearing_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($clearing_number) < 4)) {
            throw new \InvalidArgumentException('invalid length for $clearing_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 4.');
        }
    ...
    public function setSortCode($sort_code)
    {
        ...
        if ((mb_strlen($sort_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling BankAccountV3AccountIdentification., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($sort_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling BankAccountV3AccountIdentification., must be bigger than or equal to 6.');
        }
    ...
    public function setRoutingNumber($routing_number)
    {
        ...
        if ((mb_strlen($routing_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling BankAccountV3AccountIdentification., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($routing_number) < 9)) {
            throw new \InvalidArgumentException('invalid length for $routing_number when calling BankAccountV3AccountIdentification., must be bigger than or equal to 9.');
        }
