...
class CALocalAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_number
     *
     * @param string $account_number The 5- to 12-digit bank account number, without separators or whitespace.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 12)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CALocalAccountIdentification., must be smaller than or equal to 12.');
        }
        if ((mb_strlen($account_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling CALocalAccountIdentification., must be bigger than or equal to 5.');
        }
    ...
    public function setInstitutionNumber($institution_number)
    {
        ...
        if ((mb_strlen($institution_number) > 3)) {
            throw new \InvalidArgumentException('invalid length for $institution_number when calling CALocalAccountIdentification., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($institution_number) < 3)) {
            throw new \InvalidArgumentException('invalid length for $institution_number when calling CALocalAccountIdentification., must be bigger than or equal to 3.');
        }
    ...
    public function setTransitNumber($transit_number)
    {
        ...
        if ((mb_strlen($transit_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transit_number when calling CALocalAccountIdentification., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($transit_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $transit_number when calling CALocalAccountIdentification., must be bigger than or equal to 5.');
        }
