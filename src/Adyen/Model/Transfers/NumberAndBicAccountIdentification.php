...
class NumberAndBicAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 34)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 34.";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number The bank account number, without separators or whitespace. The length and format depends on the bank or country.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 34)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling NumberAndBicAccountIdentification., must be smaller than or equal to 34.');
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling NumberAndBicAccountIdentification., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling NumberAndBicAccountIdentification., must be bigger than or equal to 8.');
        }
