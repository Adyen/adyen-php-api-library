...
class AULocalAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AULocalAccountIdentification';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 9)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 9.";
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling AULocalAccountIdentification., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($account_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling AULocalAccountIdentification., must be bigger than or equal to 5.');
        }
    ...
    public function setBsbCode($bsb_code)
    {
        ...
        if ((mb_strlen($bsb_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $bsb_code when calling AULocalAccountIdentification., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($bsb_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $bsb_code when calling AULocalAccountIdentification., must be bigger than or equal to 6.');
        }
