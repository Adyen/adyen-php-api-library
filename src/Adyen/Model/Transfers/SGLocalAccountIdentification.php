...
class SGLocalAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 19)) {
     ...
     * Sets account_number
     *
     * @param string $account_number The 4- to 19-digit bank account number, without separators or whitespace.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 19)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling SGLocalAccountIdentification., must be smaller than or equal to 19.');
        }
        if ((mb_strlen($account_number) < 4)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling SGLocalAccountIdentification., must be bigger than or equal to 4.');
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 11)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling SGLocalAccountIdentification., must be smaller than or equal to 11.');
        }
        if ((mb_strlen($bic) < 8)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling SGLocalAccountIdentification., must be bigger than or equal to 8.');
        }
