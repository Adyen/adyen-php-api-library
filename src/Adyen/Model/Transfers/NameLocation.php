...
class NameLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $country_of_origin The home country in [three-digit country code](https://en.wikipedia.org/wiki/ISO_3166-1_numeric) format, used for government-controlled merchants such as embassies.
     *
     * @return self
     */
     ...
     * Sets raw_data
     *
     * @param string|null $raw_data The raw data.
     *
     * @return self
     */
