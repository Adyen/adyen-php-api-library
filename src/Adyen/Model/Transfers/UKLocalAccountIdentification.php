...
class UKLocalAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets account_number
     *
     * @param string $account_number The 8-digit bank account number, without separators or whitespace.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 8)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling UKLocalAccountIdentification., must be smaller than or equal to 8.');
        }
        if ((mb_strlen($account_number) < 8)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling UKLocalAccountIdentification., must be bigger than or equal to 8.');
        }
    ...
    public function setSortCode($sort_code)
    {
        ...
        if ((mb_strlen($sort_code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling UKLocalAccountIdentification., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($sort_code) < 6)) {
            throw new \InvalidArgumentException('invalid length for $sort_code when calling UKLocalAccountIdentification., must be bigger than or equal to 6.');
        }
