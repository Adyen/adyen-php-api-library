...
class PLLocalAccountIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PLLocalAccountIdentification';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['account_number']) > 26)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be smaller than or equal to 26.";
        }

        if ((mb_strlen($this->container['account_number']) < 26)) {
            $invalidProperties[] = "invalid value for 'account_number', the character length must be bigger than or equal to 26.";
        }
     ...
     * Sets account_number
     *
     * @param string $account_number The 26-digit bank account number ([Numer rachunku](https://pl.wikipedia.org/wiki/Numer_Rachunku_Bankowego)), without separators or whitespace.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 26)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling PLLocalAccountIdentification., must be smaller than or equal to 26.');
        }
        if ((mb_strlen($account_number) < 26)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling PLLocalAccountIdentification., must be bigger than or equal to 26.');
        }
