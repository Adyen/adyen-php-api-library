    ...
    */
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 80)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling TransferInfo., must be smaller than or equal to 80.');
        }
    ...
    public function setReferenceForBeneficiary($reference_for_beneficiary)
    {
        ...
        if ((mb_strlen($reference_for_beneficiary) > 80)) {
            throw new \InvalidArgumentException('invalid length for $reference_for_beneficiary when calling TransferInfo., must be smaller than or equal to 80.');
        }
