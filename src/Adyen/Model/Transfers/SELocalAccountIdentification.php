    ...
    */
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling SELocalAccountIdentification., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($account_number) < 7)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling SELocalAccountIdentification., must be bigger than or equal to 7.');
        }
    ...
    public function setClearingNumber($clearing_number)
    {
        ...
        if ((mb_strlen($clearing_number) > 5)) {
            throw new \InvalidArgumentException('invalid length for $clearing_number when calling SELocalAccountIdentification., must be smaller than or equal to 5.');
        }
        if ((mb_strlen($clearing_number) < 4)) {
            throw new \InvalidArgumentException('invalid length for $clearing_number when calling SELocalAccountIdentification., must be bigger than or equal to 4.');
        }
