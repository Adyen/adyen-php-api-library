...
/**
 * TransferRequestReview Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class TransferRequestReview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TransferRequestReview';
    ...
    */
     ...
     *
     * @param int|null $numberOfApprovalsRequired Specifies the number of [approvals](https://docs.adyen.com/api-explorer/transfers/latest/post/transfers/approve) required to process the transfer.
     *
     * @return self
     */
