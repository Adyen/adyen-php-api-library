...
class PayoutResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'auth_code' => 'string',
        'dcc_amount' => '\Adyen\Model\Payout\Amount',
        'dcc_signature' => 'string',
        'fraud_result' => '\Adyen\Model\Payout\FraudResult',
        'issuer_url' => 'string',
        'md' => 'string',
        'pa_request' => 'string',
    ...
    */
     ...
     * Sets dcc_amount
     *
     * @param \Adyen\Model\Payout\Amount|null $dcc_amount dcc_amount
     *
     * @return self
     */
     ...
     * Sets fraud_result
     *
     * @param \Adyen\Model\Payout\FraudResult|null $fraud_result fraud_result
     *
     * @return self
     */
