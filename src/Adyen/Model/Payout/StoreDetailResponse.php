...
class StoreDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $recurringDetailReference The token which you can use later on for submitting the payout.
     *
     * @return self
     */
     ...
     * Sets resultCode
     *
     * @param string $resultCode The result code of the transaction. `Success` indicates that the details were stored successfully.
     *
     * @return self
     */
