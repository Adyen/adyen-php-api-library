...
/**
 * StoreDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class StoreDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoreDetailResponse';
    ...
    */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference A new reference to uniquely identify this request.
     *
     * @return self
     */
     ...
     *
     * @param string $recurring_detail_reference The token which you can use later on for submitting the payout.
     *
     * @return self
     */
     ...
     * Sets result_code
     *
     * @param string $result_code The result code of the transaction. `Success` indicates that the details were stored successfully.
     *
     * @return self
     */
