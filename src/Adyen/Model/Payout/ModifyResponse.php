 ...
 */
class ModifyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModifyResponse';
    ...
    */
     ...
     *
     * @param array<string,string>|null $additional_data This field contains additional data, which may be returned in a particular response.
     *
     * @return self
     */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference Adyen's 16-character string reference associated with the transaction. This value is globally unique; quote it when communicating with us about this response.
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param string $response The response: * In case of success, it is either `payout-confirm-received` or `payout-decline-received`. * In case of an error, an informational message is returned.
     *
     * @return self
     */
