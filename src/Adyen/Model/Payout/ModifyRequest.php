...
class ModifyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets additionalData
     *
     * @param array<string,string>|null $additionalData This field contains additional data, which may be required for a particular payout request.
     *
     * @return self
     */
     ...
     *
     * @param string $originalReference The PSP reference received in the `/submitThirdParty` response.
     *
     * @return self
     */
