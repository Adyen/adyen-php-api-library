...
class Card implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month The card expiry month. Format: 2 digits, zero-padded for single digits. For example: * 03 = March * 11 = November
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string $number The card number (4-19 characters). Do not use any separators. When this value is returned in a response, only the last 4 digits of the card number are returned.
     *
     * @return self
     */
