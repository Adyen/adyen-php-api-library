...
class SubmitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets refusal_reason
     *
     * @param string|null $refusal_reason In case of refusal, an informational message for the reason.
     *
     * @return self
     */
     ...
     * Sets result_code
     *
     * @param string $result_code The response: * In case of success, it is `payout-submit-received`. * In case of an error, an informational message is returned.
     *
     * @return self
     */
