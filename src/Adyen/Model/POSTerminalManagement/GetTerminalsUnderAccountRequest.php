...
/**
 * GetTerminalsUnderAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class GetTerminalsUnderAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTerminalsUnderAccountRequest';
    ...
    */
     ...
     * Sets companyAccount
     *
     * @param string $companyAccount Your company account. If you only specify this parameter, the response includes all terminals at all account levels.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchantAccount The merchant account. This is required if you are retrieving the terminals assigned to a store.If you don't specify a `store` the response includes the terminals assigned to the specified merchant account and the terminals assigned to the stores under this merchant account.
     *
     * @return self
     */
     ...
     * Sets store
     *
     * @param string|null $store The store code of the store. With this parameter, the response only includes the terminals assigned to the specified store.
     *
     * @return self
     */
