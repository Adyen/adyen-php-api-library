...
/**
 * GetStoresUnderAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class GetStoresUnderAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetStoresUnderAccountRequest';
    ...
    */
     ...
     *
     * @param string $company_account The company account. If you only specify this parameter, the response includes the stores of all merchant accounts that are associated with the company account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchant_account The merchant account. With this parameter, the response only includes the stores of the specified merchant account.
     *
     * @return self
     */
