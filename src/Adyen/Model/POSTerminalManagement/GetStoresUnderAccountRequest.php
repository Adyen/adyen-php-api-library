...
class GetStoresUnderAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets companyAccount
     *
     * @param string $companyAccount The company account. If you only specify this parameter, the response includes the stores of all merchant accounts that are associated with the company account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchantAccount The merchant account. With this parameter, the response only includes the stores of the specified merchant account.
     *
     * @return self
     */
