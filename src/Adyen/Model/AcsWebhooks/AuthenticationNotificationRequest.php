...
class AuthenticationNotificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AuthenticationNotificationRequest';
    ...
    public const TYPE_BALANCE_PLATFORM_AUTHENTICATION_CREATED = 'balancePlatform.authentication.created';
    ...
    {
        return [
            self::TYPE_BALANCE_PLATFORM_AUTHENTICATION_CREATED,
        ];
    }
    ...
    */
     ...
     * Gets data
     *
     * @return \Adyen\Model\AcsWebhooks\AuthenticationNotificationData
     */
     ...
     * Sets data
     *
     * @param \Adyen\Model\AcsWebhooks\AuthenticationNotificationData $data data
     *
     * @return self
     */
