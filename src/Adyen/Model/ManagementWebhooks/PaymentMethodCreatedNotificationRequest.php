...
/**
 * PaymentMethodCreatedNotificationRequest Class Doc Comment
 *
 * @package  Adyen\Model\ManagementWebhooks
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodCreatedNotificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentMethodCreatedNotificationRequest';
    ...
    public const TYPE_PAYMENT_METHOD_CREATED = 'paymentMethod.created';
    ...
    {
        return [
            self::TYPE_PAYMENT_METHOD_CREATED,
        ];
    }
