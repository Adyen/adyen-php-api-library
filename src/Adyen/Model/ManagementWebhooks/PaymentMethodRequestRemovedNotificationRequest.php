...
/**
 * PaymentMethodRequestRemovedNotificationRequest Class Doc Comment
 *
 * @package  Adyen\Model\ManagementWebhooks
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodRequestRemovedNotificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PaymentMethodRequestRemovedNotificationRequest';
    ...
    {
        return [
            self::TYPE_PAYMENT_METHOD_REQUEST_REMOVED,
        ];
    }
