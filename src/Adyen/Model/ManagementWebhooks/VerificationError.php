...
class VerificationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VerificationError';
    ...
    protected static array $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'remediatingActions' => '\Adyen\Model\ManagementWebhooks\RemediatingAction[]',
        'subErrors' => '\Adyen\Model\ManagementWebhooks\VerificationErrorRecursive[]',
        'type' => 'string'
    ];
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message The verification error message.
     *
     * @return self
     */
     ...
     *
     * @return \Adyen\Model\ManagementWebhooks\RemediatingAction[]|null
     */
     ...
     *
     * @param \Adyen\Model\ManagementWebhooks\RemediatingAction[]|null $remediatingActions The actions that you can take to resolve the verification error.
     *
     * @return self
     */
    public function setRemediatingActions($remediatingActions): self
    {
     ...
     * Gets subErrors
     *
     * @return \Adyen\Model\ManagementWebhooks\VerificationErrorRecursive[]|null
     */
     ...
     * @return self
     */
    public function setSubErrors($subErrors): self
    {
     ...
     * Sets type
     *
     * @param string|null $type The type of verification error.  Possible values: **invalidInput**, **dataMissing**, and **pendingStatus**.
     *
     * @return self
     */
