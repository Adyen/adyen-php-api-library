...
class CreateSessionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('setupToken', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['setupToken'] === null) {
            $invalidProperties[] = "'setupToken' can't be null";
        }
     ...
     *
     * @param string $merchantAccount The unique identifier of your merchant account.
     *
     * @return self
     */
    ...
    {
        return $this->container['setupToken'];
    }
