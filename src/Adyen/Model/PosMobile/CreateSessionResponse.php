...
class CreateSessionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of the session.
     *
     * @return self
     */
     ...
     * Sets installationId
     *
     * @param string|null $installationId The unique identifier of the SDK installation. If you create the [Terminal API](https://docs.adyen.com/point-of-sale/design-your-integration/terminal-api/) transaction request on your backend, use this as the `POIID` in the `MessageHeader` of the request.
     *
     * @return self
     */
     ...
     *
     * @param string|null $merchantAccount The unique identifier of your merchant account.
     *
     * @return self
     */
     ...
     * Sets sdkData
     *
     * @param string|null $sdkData The data that the SDK uses to authenticate responses from the Adyen payments platform. Pass this value to your POS app.
     *
     * @return self
     */
     ...
     * Sets store
     *
     * @param string|null $store The unique identifier of the store that you want to process transactions for.
     *
     * @return self
     */
