...
class Device implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets formFactor
     *
     * @param string|null $formFactor The type of the device used for provisioning the network token.  For example, **phone**, **mobile_phone**, **watch**, **mobilephone_or_tablet**, etc
     *
     * @return self
     */
     ...
     * Sets osName
     *
     * @param string|null $osName The operating system of the device used for provisioning the network token.
     *
     * @return self
     */
