...
class VerificationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'string',
        'message' => 'string',
        'remediatingActions' => '\Adyen\Model\ConfigurationWebhooks\RemediatingAction[]',
        'subErrors' => '\Adyen\Model\ConfigurationWebhooks\VerificationErrorRecursive[]',
        'type' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \Adyen\Model\ConfigurationWebhooks\RemediatingAction[]|null
     */
     ...
     *
     * @param \Adyen\Model\ConfigurationWebhooks\RemediatingAction[]|null $remediatingActions Contains the actions that you can take to resolve the verification error.
     *
     * @return self
     */
     ...
     * Gets subErrors
     *
     * @return \Adyen\Model\ConfigurationWebhooks\VerificationErrorRecursive[]|null
     */
     ...
     * Sets subErrors
     *
     * @param \Adyen\Model\ConfigurationWebhooks\VerificationErrorRecursive[]|null $subErrors Contains more granular information about the verification error.
     *
     * @return self
     */
