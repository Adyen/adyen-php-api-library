...
class PaymentInstrument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \Adyen\Model\ConfigurationWebhooks\PaymentInstrumentAdditionalBankAccountIdentificationsInner[]|null
     */
     ...
     *
     * @param \Adyen\Model\ConfigurationWebhooks\PaymentInstrumentAdditionalBankAccountIdentificationsInner[]|null $additionalBankAccountIdentifications Contains optional, additional business account details. Returned when you create a payment instrument with `type` **bankAccount**.
     *
     * @return self
     */
