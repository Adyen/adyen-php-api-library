...
/**
 * AccountPayoutConfigWebhookData Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class AccountPayoutConfigWebhookData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountPayoutConfigWebhookData';
    ...
    */
     ...
     *
     * @param string|null $balanceAccountId The unique identifier of the balance account to which the payout schedule was applied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $balanceAccountPayoutScheduleId The unique identifier of the balance platform payout schedule that was applied to the balance account.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description used for all payouts initiated by this payout schedule.  Maximum length: 140 characters. If your description is longer, it may be truncated.
     *
     * @return self
     */
     ...
     * Sets frequency
     *
     * @param string|null $frequency The frequency of payouts initiated by this payout schedule.  Possible values: * daily * weekdays * weekly * monthly
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference Your internal reference of the payout schedule.
     *
     * @return self
     */
     ...
     * Sets retainedAmount
     *
     * @param int|null $retainedAmount The amount of funds that must remain available in the balance account after an execution of the payout schedule. If the funds in the balance account are less than the retained amount, the execution is not initiated.
     *
     * @return self
     */
