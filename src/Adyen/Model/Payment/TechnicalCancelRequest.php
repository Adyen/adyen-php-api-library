...
class TechnicalCancelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['originalMerchantReference'] === null) {
            $invalidProperties[] = "'originalMerchantReference' can't be null";
        }
     ...
     *
     * @param \Adyen\Model\Payment\Amount|null $modificationAmount modificationAmount
     *
     * @return self
     */
     ...
     *
     * @param string $originalMerchantReference The original merchant reference to cancel.
     *
     * @return self
     */
