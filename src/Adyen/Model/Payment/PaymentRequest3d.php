...
class PaymentRequest3d implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('paResponse', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['paResponse'] === null) {
            $invalidProperties[] = "'paResponse' can't be null";
        }
     ...
     * Sets amount
     *
     * @param \Adyen\Model\Payment\Amount|null $amount amount
     *
     * @return self
     */
    ...
    {
        return $this->container['paResponse'];
    }

    /**
     * Sets paResponse
     *
     * @param string $paResponse Payment authorisation response returned by the card issuer. The `paResponse` field holds the PaRes value received from the card issuer.
     *
     * @return self
     */
    public function setPaResponse($paResponse)
    {
        if (is_null($paResponse)) {
            throw new \InvalidArgumentException('non-nullable paResponse cannot be null');
        }
        $this->container['paResponse'] = $paResponse;
