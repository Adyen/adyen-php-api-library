...
/**
 * AdjustAuthorisationRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class AdjustAuthorisationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdjustAuthorisationRequest';
    ...
    protected static $openAPITypes = [
        ...
        'modificationAmount' => '\Adyen\Model\Payment\Amount',
    ...
    */
     ...
     *
     * @param \Adyen\Model\Payment\Amount $modificationAmount modificationAmount
     *
     * @return self
     */
     ...
     * Sets splits
     *
     * @param \Adyen\Model\Payment\Split[]|null $splits An array of objects specifying how the amount should be split between accounts when using Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).
     *
     * @return self
     */
