...
/**
 * RecurringTokenStoreOperation Class Doc Comment
 *
 * @package  Adyen\Model\TokenizationWebhooks
 * @implements \ArrayAccess<string, mixed>
 */
class RecurringTokenStoreOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RecurringTokenStoreOperation';
    ...
    */
     ...
     *
     * @param string $merchantAccount The identifier of the merchant account related to the event that triggered the webhook.
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string $operation A text description that provides details about the operation, intended for audit purposes.
     *
     * @return self
     */
     ...
     *
     * @param string $shopperReference Your unique shopper reference that is associated with the `storedPaymentMethodId`.
     *
     * @return self
     */
     ...
     *
     * @param string $storedPaymentMethodId The ID of the token.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the payment method.
     *
     * @return self
     */
