...
class WebData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('webAddressId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets webAddress
     *
     * @param string|null $webAddress The URL of the website or the app store URL.
     *
     * @return self
     */
    ...
    {
        return $this->container['webAddressId'];
    }

    /**
     * Sets webAddressId
     *
     * @param string|null $webAddressId The unique identifier of the web address.
     *
     * @return self
     */
