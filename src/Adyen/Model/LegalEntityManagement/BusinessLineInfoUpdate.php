...
class BusinessLineInfoUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets industry_code
     *
     * @param string|null $industry_code A code that represents the industry of your legal entity. For example, **4431A** for computer software stores.
     *
     * @return self
     */
     ...
     *
     * @param string|null $legal_entity_id Unique identifier of the [legal entity](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities__resParam_id) that owns the business line.
     *
     * @return self
     */
