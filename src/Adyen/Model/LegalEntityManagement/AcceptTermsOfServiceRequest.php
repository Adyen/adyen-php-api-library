...
class AcceptTermsOfServiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets accepted_by
     *
     * @param string|null $accepted_by The unique identifier of the user accepting the Terms of Service.
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address The IP address of the user accepting the Terms of Service.
     *
     * @return self
     */
