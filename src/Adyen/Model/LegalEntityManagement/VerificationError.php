...
class VerificationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'code' => 'string',
        'message' => 'string',
        'remediating_actions' => '\Adyen\Model\LegalEntityManagement\RemediatingAction[]',
        'sub_errors' => '\Adyen\Model\LegalEntityManagement\VerificationErrorRecursive[]',
        'type' => 'string'
    ];
    ...
    protected static $setters = [
        ...
        'code' => 'setCode',
        'message' => 'setMessage',
        'remediating_actions' => 'setRemediatingActions',
        'sub_errors' => 'setSubErrors',
        'type' => 'setType'
    ];
    ...
    protected static $getters = [
        ...
        'code' => 'getCode',
        'message' => 'getMessage',
        'remediating_actions' => 'getRemediatingActions',
        'sub_errors' => 'getSubErrors',
        'type' => 'getType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('remediating_actions', $data ?? [], null);
        $this->setIfExists('sub_errors', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets remediating_actions
     *
     * @return \Adyen\Model\LegalEntityManagement\RemediatingAction[]|null
     */
    public function getRemediatingActions()
    {
        return $this->container['remediating_actions'];
    }

    /**
     * Sets remediating_actions
     *
     * @param \Adyen\Model\LegalEntityManagement\RemediatingAction[]|null $remediating_actions An object containing possible solutions to fix a verification error.
     *
     * @return self
     */
    public function setRemediatingActions($remediating_actions)
    {
        if (is_null($remediating_actions)) {
            throw new \InvalidArgumentException('non-nullable remediating_actions cannot be null');
        }
        $this->container['remediating_actions'] = $remediating_actions;
    ...
    {
        return $this->container['sub_errors'];
    }

    /**
     * Sets sub_errors
     *
     * @param \Adyen\Model\LegalEntityManagement\VerificationErrorRecursive[]|null $sub_errors An array containing more granular information about the cause of the verification error.
     *
     * @return self
     */
    public function setSubErrors($sub_errors)
    {
        if (is_null($sub_errors)) {
            throw new \InvalidArgumentException('non-nullable sub_errors cannot be null');
        }
        $this->container['sub_errors'] = $sub_errors;
