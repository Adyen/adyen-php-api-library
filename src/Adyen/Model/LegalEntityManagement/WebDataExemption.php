...
class WebDataExemption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebDataExemption';
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason The reason why the web data was not provided. Possible value: **noOnlinePresence**.
     *
     * @return self
     */
