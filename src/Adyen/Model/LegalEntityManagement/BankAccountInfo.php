...
class BankAccountInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_identification' => '\Adyen\Model\LegalEntityManagement\BankAccount',
        'account_type' => 'string',
        'country_code' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \Adyen\Model\LegalEntityManagement\BankAccount|null
     */
     ...
     *
     * @param \Adyen\Model\LegalEntityManagement\BankAccount|null $account_identification account_identification
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code The two-character [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code where the bank account is registered. For example, **NL**.
     *
     * @return self
     */
