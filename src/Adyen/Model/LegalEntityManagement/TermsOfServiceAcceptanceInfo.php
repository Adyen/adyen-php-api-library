...
class TermsOfServiceAcceptanceInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('accepted_for', $data ?? [], null);
    ...
    */
     ...
     * Sets accepted_for
     *
     * @param string|null $accepted_for The unique identifier of the legal entity for which the Terms of Service are accepted.
     *
     * @return self
     */
    public function setAcceptedFor($accepted_for)
    {
        if (is_null($accepted_for)) {
            throw new \InvalidArgumentException('non-nullable accepted_for cannot be null');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date when the Terms of Service were accepted.
     *
     * @return self
     */
