...
class LegalEntityAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets nominee
     *
     * @param bool|null $nominee Default value: **false**Indicates if the `type` **director**, **secondaryPartner** or **shareholder** is a nominee. Only applicable to New Zealand.
     *
     * @return self
     */
