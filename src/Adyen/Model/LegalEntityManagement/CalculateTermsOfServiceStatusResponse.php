...
class CalculateTermsOfServiceStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'terms_of_service_types' => 'setTermsOfServiceTypes'
    ];
    ...
    protected static $getters = [
        'terms_of_service_types' => 'getTermsOfServiceTypes'
    ];
    ...
    {
        $this->setIfExists('terms_of_service_types', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets terms_of_service_types
     *
     * @return string[]|null
     */
    public function getTermsOfServiceTypes()
    {
        return $this->container['terms_of_service_types'];
    }

    /**
     * Sets terms_of_service_types
     *
     * @param string[]|null $terms_of_service_types The type of Terms of Service that the legal entity needs to accept. If empty, no Terms of Service needs to be accepted.
     *
     * @return self
     */
    public function setTermsOfServiceTypes($terms_of_service_types)
    {
        if (is_null($terms_of_service_types)) {
            throw new \InvalidArgumentException('non-nullable terms_of_service_types cannot be null');
        }
        $allowedValues = $this->getTermsOfServiceTypesAllowableValues();
        if (array_diff($terms_of_service_types, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'terms_of_service_types', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }
        $this->container['terms_of_service_types'] = $terms_of_service_types;
