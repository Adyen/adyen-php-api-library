...
/**
 * PciSigningRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PciSigningRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PciSigningRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pciTemplateReferences'] === null) {
            $invalidProperties[] = "'pciTemplateReferences' can't be null";
        }
        if ($this->container['signedBy'] === null) {
            $invalidProperties[] = "'signedBy' can't be null";
        }
     ...
     *
     * @param string[] $pciTemplateReferences The array of Adyen-generated unique identifiers for the questionnaires.
     *
     * @return self
     */
     ...
     * Sets signedBy
     *
     * @param string $signedBy The [legal entity ID](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities__resParam_id) of the individual who signs the PCI questionnaire.
     *
     * @return self
     */
