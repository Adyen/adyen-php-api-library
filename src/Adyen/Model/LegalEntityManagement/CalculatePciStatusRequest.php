...
/**
 * CalculatePciStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CalculatePciStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalculatePciStatusRequest';
