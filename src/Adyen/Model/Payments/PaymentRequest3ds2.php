...
class PaymentRequest3ds2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'three_ds2_token' => 'setThreeDs2Token',
    ...
    protected static $getters = [
        ...
        'three_ds2_token' => 'getThreeDs2Token',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('three_ds2_token', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets three_ds2_token
     *
     * @return string|null
     */
    public function getThreeDs2Token()
    {
        return $this->container['three_ds2_token'];
    }

    /**
     * Sets three_ds2_token
     *
     * @param string|null $three_ds2_token The ThreeDS2Token that was returned in the /authorise call.
     *
     * @return self
     */
    public function setThreeDs2Token($three_ds2_token)
    {
        if (is_null($three_ds2_token)) {
            throw new \InvalidArgumentException('non-nullable three_ds2_token cannot be null');
        }
        $this->container['three_ds2_token'] = $three_ds2_token;
