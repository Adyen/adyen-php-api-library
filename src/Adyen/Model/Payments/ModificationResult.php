...
class ModificationResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets additionalData
     *
     * @param array<string,string>|null $additionalData This field contains additional data, which may be returned in a particular modification response.
     *
     * @return self
     */
     ...
     * Sets pspReference
     *
     * @param string $pspReference Adyen's 16-character string reference associated with the transaction/request. This value is globally unique; quote it when communicating with us about this request.
     *
     * @return self
     */
