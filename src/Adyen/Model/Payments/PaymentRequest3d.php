...
/**
 * PaymentRequest3d Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class PaymentRequest3d implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequest3d';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pa_response', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pa_response'] === null) {
            $invalidProperties[] = "'pa_response' can't be null";
        }
     ...
     * Sets amount
     *
     * @param \Adyen\Model\Payments\Amount|null $amount amount
     *
     * @return self
     */
     ...
     * Sets md
     *
     * @param string $md The payment session identifier returned by the card issuer.
     *
     * @return self
     */
    ...
    {
        return $this->container['pa_response'];
    }

    /**
     * Sets pa_response
     *
     * @param string $pa_response Payment authorisation response returned by the card issuer. The `paResponse` field holds the PaRes value received from the card issuer.
     *
     * @return self
     */
    public function setPaResponse($pa_response)
    {
        if (is_null($pa_response)) {
            throw new \InvalidArgumentException('non-nullable pa_response cannot be null');
        }
        $this->container['pa_response'] = $pa_response;
