...
/**
 * AuthenticationResultRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class AuthenticationResultRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticationResultRequest';
    ...
    */
     ...
     *
     * @param string $merchant_account The merchant account identifier, with which the authentication was processed.
     *
     * @return self
     */
     ...
     * Sets psp_reference
     *
     * @param string $psp_reference The pspReference identifier for the transaction.
     *
     * @return self
     */
