...
class AuthenticationResultRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $merchantAccount The merchant account identifier, with which the authentication was processed.
     *
     * @return self
     */
     ...
     * Sets pspReference
     *
     * @param string $pspReference The pspReference identifier for the transaction.
     *
     * @return self
     */
