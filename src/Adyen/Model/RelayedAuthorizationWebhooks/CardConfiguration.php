...
class CardConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'bulkAddress' => '\Adyen\Model\RelayedAuthorizationWebhooks\BulkAddress',
        'cardImageId' => 'string',
        'carrier' => 'string',
    ...
    */
     ...
     * Gets bulkAddress
     *
     * @return \Adyen\Model\RelayedAuthorizationWebhooks\BulkAddress|null
     */
     ...
     * Sets bulkAddress
     *
     * @param \Adyen\Model\RelayedAuthorizationWebhooks\BulkAddress|null $bulkAddress bulkAddress
     *
     * @return self
     */
     ...
     * Sets languages
     *
     * @param string[]|null $languages A list of two-letter [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language codes of the card. For example, **[en,es]**.
     *
     * @return self
     */
