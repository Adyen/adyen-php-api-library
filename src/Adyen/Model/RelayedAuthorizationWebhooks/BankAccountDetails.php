...
class BankAccountDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets iban
     *
     * @param string|null $iban The international bank account number as defined in the [ISO-13616](https://www.iso.org/standard/81090.html) standard.
     *
     * @return self
     */
     ...
     * Sets routingNumber
     *
     * @param string|null $routingNumber The [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or whitespace.
     *
     * @return self
     */
     ...
     * Sets sortCode
     *
     * @param string|null $sortCode The [sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or whitespace.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type **iban** or **usLocal** or **ukLocal**
     *
     * @return self
     */
