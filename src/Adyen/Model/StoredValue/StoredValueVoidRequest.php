...
class StoredValueVoidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $originalReference The original pspReference of the payment to modify.
     *
     * @return self
     */
     ...
     *
     * @param string|null $tenderReference The reference of the tender.
     *
     * @return self
     */
     ...
     *
     * @param string|null $uniqueTerminalId The unique ID of a POS terminal.
     *
     * @return self
     */
