...
/**
 * StoredValueLoadRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class StoredValueLoadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoredValueLoadRequest';
    ...
    public const LOAD_TYPE_MERCHANDISE_RETURN = 'merchandiseReturn';
    public const LOAD_TYPE_LOAD = 'load';
    ...
    {
        return [
            self::LOAD_TYPE_MERCHANDISE_RETURN,
            self::LOAD_TYPE_LOAD,
        ];
    }
    /**
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('load_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['load_type']) && !in_array($this->container['load_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'load_type', must be one of '%s'",
                $this->container['load_type'],
     ...
     * Gets amount
     *
     * @return \Adyen\Model\StoredValue\Amount
     */
     ...
     * Sets amount
     *
     * @param \Adyen\Model\StoredValue\Amount $amount amount
     *
     * @return self
     */
     ...
     * Sets load_type
     *
     * @param string|null $load_type The type of load you are trying to do, when absent we default to 'Load'
     *
     * @return self
     */
    public function setLoadType($load_type)
    {
        if (is_null($load_type)) {
            throw new \InvalidArgumentException('non-nullable load_type cannot be null');
        }
        $allowedValues = $this->getLoadTypeAllowableValues();
        if (!in_array($load_type, $allowedValues, true)) {
