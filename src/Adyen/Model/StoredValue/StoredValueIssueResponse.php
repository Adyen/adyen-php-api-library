...
/**
 * StoredValueIssueResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class StoredValueIssueResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StoredValueIssueResponse';
    ...
    */
     ...
     * Sets payment_method
     *
     * @param array<string,string>|null $payment_method The collection that contains the type of the payment method and its specific information if available
     *
     * @return self
     */
