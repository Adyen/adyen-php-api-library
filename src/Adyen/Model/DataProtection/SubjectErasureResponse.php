...
class SubjectErasureResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubjectErasureResponse';
    ...
    public const RESULT_ACTIVE_RECURRING_TOKEN_EXISTS = 'ACTIVE_RECURRING_TOKEN_EXISTS';
    public const RESULT_ALREADY_PROCESSED = 'ALREADY_PROCESSED';
    public const RESULT_PAYMENT_NOT_FOUND = 'PAYMENT_NOT_FOUND';
    ...
    {
        return [
            self::RESULT_ACTIVE_RECURRING_TOKEN_EXISTS,
            self::RESULT_ALREADY_PROCESSED,
            self::RESULT_PAYMENT_NOT_FOUND,
            self::RESULT_SUCCESS,
        ];
    }
    /**
    ...
    */
     ...
     * Sets result
     *
     * @param string|null $result The result of this operation.
     *
     * @return self
     */
