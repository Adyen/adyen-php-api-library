...
class Localization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Gets secondaryLanguage
     *
     * @return string|null
     */
    public function getSecondaryLanguage()
    {
        return $this->container['secondaryLanguage'];
    }

    /**
     * Sets secondaryLanguage
     *
     * @param string|null $secondaryLanguage Secondary language of the terminal.
     *
     * @return self
     */
