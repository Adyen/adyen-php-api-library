...
/**
 * TerminalConnectivityEthernet Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class TerminalConnectivityEthernet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalConnectivityEthernet';
    ...
    */
     ...
     * Sets ipAddress
     *
     * @param string|null $ipAddress The terminal's ethernet IP address.
     *
     * @return self
     */
     ...
     *
     * @param string|null $linkNegotiation The ethernet link negotiation that the terminal uses.
     *
     * @return self
     */
     ...
     * Sets macAddress
     *
     * @param string|null $macAddress The terminal's ethernet MAC address.
     *
     * @return self
     */
