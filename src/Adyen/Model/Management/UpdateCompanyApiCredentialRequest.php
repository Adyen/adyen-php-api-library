...
/**
 * UpdateCompanyApiCredentialRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class UpdateCompanyApiCredentialRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateCompanyApiCredentialRequest';
    ...
    */
     ...
     *
     * @param string[]|null $associated_merchant_accounts List of merchant accounts that the API credential has access to.
     *
     * @return self
     */
