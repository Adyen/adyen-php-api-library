...
class MealVoucherFRInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('conecs_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['conecs_id'] === null) {
            $invalidProperties[] = "'conecs_id' can't be null";
        }
    ...
    {
        return $this->container['conecs_id'];
    }

    /**
     * Sets conecs_id
     *
     * @param string $conecs_id Meal Voucher conecsId. Format: digits only
     *
     * @return self
     */
    public function setConecsId($conecs_id)
    {
        if (is_null($conecs_id)) {
            throw new \InvalidArgumentException('non-nullable conecs_id cannot be null');
        }
        $this->container['conecs_id'] = $conecs_id;
     ...
     * Sets sub_types
     *
     * @param string[] $sub_types The list of additional payment methods. Allowed values: **mealVoucher_FR_endenred**, **mealVoucher_FR_groupeup**, **mealVoucher_FR_natixis**, **mealVoucher_FR_sodexo**.
     *
     * @return self
     */
