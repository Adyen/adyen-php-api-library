...
class Surcharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'ask_confirmation' => 'setAskConfirmation',
    ...
    protected static $getters = [
        'ask_confirmation' => 'getAskConfirmation',
    ...
    {
        $this->setIfExists('ask_confirmation', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets ask_confirmation
     *
     * @return bool|null
     */
    public function getAskConfirmation()
    {
        return $this->container['ask_confirmation'];
    }

    /**
     * Sets ask_confirmation
     *
     * @param bool|null $ask_confirmation Show the surcharge details on the terminal, so the shopper can confirm.
     *
     * @return self
     */
    public function setAskConfirmation($ask_confirmation)
    {
        if (is_null($ask_confirmation)) {
            throw new \InvalidArgumentException('non-nullable ask_confirmation cannot be null');
        }
        $this->container['ask_confirmation'] = $ask_confirmation;
