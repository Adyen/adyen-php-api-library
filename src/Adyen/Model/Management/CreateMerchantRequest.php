...
class CreateMerchantRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $business_line_id The unique identifier of the [business line](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/businessLines). Required for an Adyen for Platforms Manage integration.
     *
     * @return self
     */
     ...
     * Sets company_id
     *
     * @param string $company_id The unique identifier of the company account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $legal_entity_id The unique identifier of the [legal entity](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities). Required for an Adyen for Platforms Manage integration.
     *
     * @return self
     */
     ...
     * Sets pricing_plan
     *
     * @param string|null $pricing_plan Sets the pricing plan for the merchant account. Required for an Adyen for Platforms Manage integration. Your Adyen contact will provide the values that you can use.
     *
     * @return self
     */
     ...
     * Sets sales_channels
     *
     * @param string[]|null $sales_channels List of sales channels that the merchant will process payments with
     *
     * @return self
     */
