...
/**
 * MeApiCredential Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class MeApiCredential implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeApiCredential';
    ...
    */
     ...
     *
     * @param string[]|null $associated_merchant_accounts List of merchant accounts that the API credential has explicit access to.   If the credential has access to a company, this implies access to all merchant accounts and no merchants for that company will be included.
     *
     * @return self
     */
     ...
     * Sets company_name
     *
     * @param string|null $company_name Name of the company linked to the API credential.
     *
     * @return self
     */
