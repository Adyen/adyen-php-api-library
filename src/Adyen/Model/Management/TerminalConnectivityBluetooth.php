...
class TerminalConnectivityBluetooth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalConnectivityBluetooth';
    ...
    */
     ...
     * Sets ipAddress
     *
     * @param string|null $ipAddress The terminal's Bluetooth IP address.
     *
     * @return self
     */
     ...
     * Sets macAddress
     *
     * @param string|null $macAddress The terminal's Bluetooth MAC address.
     *
     * @return self
     */
