...
class Standalone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets currencyCode
     *
     * @param string|null $currencyCode The default currency of the standalone payment terminal as an [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) currency code.
     *
     * @return self
     */
    ...
    /**
     * Gets enableStandalone
     *
     * @return bool|null
     */
    public function getEnableStandalone()
    {
        return $this->container['enableStandalone'];
    }

    /**
     * Sets enableStandalone
     *
     * @param bool|null $enableStandalone Enable standalone mode.
     *
     * @return self
     */
