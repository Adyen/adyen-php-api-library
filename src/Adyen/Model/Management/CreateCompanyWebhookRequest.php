...
class CreateCompanyWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filter_merchant_account_type'] === null) {
            $invalidProperties[] = "'filter_merchant_account_type' can't be null";
        }
        ...
        if ($this->container['filter_merchant_accounts'] === null) {
            $invalidProperties[] = "'filter_merchant_accounts' can't be null";
        }
     ...
     *
     * @param string $filter_merchant_account_type Shows how merchant accounts are filtered when configuring the webhook. Possible values: * **includeAccounts**: The webhook is configured for the merchant accounts listed in `filterMerchantAccounts`. * **excludeAccounts**: The webhook is not configured for the merchant accounts listed in `filterMerchantAccounts`. * **allAccounts**: Includes all merchant accounts, and does not require specifying `filterMerchantAccounts`.
     *
     * @return self
     */
