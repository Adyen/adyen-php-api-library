...
/**
 * CreateCompanyApiCredentialRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CreateCompanyApiCredentialRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCompanyApiCredentialRequest';
    ...
    */
     ...
     *
     * @param string[]|null $allowed_origins List of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
     *
     * @return self
     */
