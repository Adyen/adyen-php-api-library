...
class TerminalConnectivityWifi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TerminalConnectivityWifi';
    ...
    */
     ...
     * Sets ipAddress
     *
     * @param string|null $ipAddress The terminal's IP address in the Wi-Fi network.
     *
     * @return self
     */
     ...
     * Sets macAddress
     *
     * @param string|null $macAddress The terminal's MAC address in the Wi-Fi network.
     *
     * @return self
     */
     ...
     * Sets ssid
     *
     * @param string|null $ssid The SSID of the Wi-Fi network that the terminal is connected to.
     *
     * @return self
     */
