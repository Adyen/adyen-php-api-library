...
/**
 * KlarnaResponseInfo Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class KlarnaResponseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KlarnaResponseInfo';
    ...
    */
     ...
     * Sets autoCapture
     *
     * @param bool|null $autoCapture Indicates the status of [Automatic capture](https://docs.adyen.com/online-payments/capture#automatic-capture).
     *
     * @return self
     */
     ...
     * Sets disputeEmail
     *
     * @param string|null $disputeEmail The email address for disputes.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region of operation.
     *
     * @return self
     */
