...
class CompanyLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'apiCredentials' => '\Adyen\Model\Management\LinksElement',
    ...
    {
        $this->setIfExists('apiCredentials', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['apiCredentials'];
    }

    /**
     * Sets apiCredentials
     *
     * @param \Adyen\Model\Management\LinksElement|null $apiCredentials apiCredentials
     *
     * @return self
     */
