...
class ShopperStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $doing_business_as_name The name you want to be shown on the shopper's bank or credit card statement. Can't be all numbers. If a shopper statement is present, this field is required.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of shopperstatement you want to use: fixed, append or dynamic
     *
     * @return self
     */
