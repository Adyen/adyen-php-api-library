...
/**
 * PayToResponseInfo Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class PayToResponseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayToResponseInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('payToPurpose', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['payToPurpose'];
    }
     ...
     * @return self
     */
    public function setPayToPurpose($payToPurpose)
    {
        $this->container['payToPurpose'] = $payToPurpose;
