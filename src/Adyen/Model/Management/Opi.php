...
class Opi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'payAtTableStoreNumber' => 'setPayAtTableStoreNumber',
        'payAtTableURL' => 'setPayAtTableURL'
    ];
    ...
    protected static $getters = [
        ...
        'payAtTableStoreNumber' => 'getPayAtTableStoreNumber',
        'payAtTableURL' => 'getPayAtTableURL'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payAtTableStoreNumber', $data ?? [], null);
        $this->setIfExists('payAtTableURL', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $enablePayAtTable Indicates if Pay at table is enabled.
     *
     * @return self
     */
    ...
    /**
     * Gets payAtTableStoreNumber
     *
     * @return string|null
     */
    public function getPayAtTableStoreNumber()
    {
        return $this->container['payAtTableStoreNumber'];
    }

    /**
     * Sets payAtTableStoreNumber
     *
     * @param string|null $payAtTableStoreNumber The store number to use for Pay at Table.
     *
     * @return self
     */
    ...
    {
        return $this->container['payAtTableURL'];
    }

    /**
     * Sets payAtTableURL
     *
     * @param string|null $payAtTableURL The URL and port number used for Pay at Table communication.
     *
     * @return self
     */
