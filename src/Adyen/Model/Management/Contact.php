...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets firstName
     *
     * @param string|null $firstName The individual's first name.
     *
     * @return self
     */
     ...
     * Sets lastName
     *
     * @param string|null $lastName The individual's last name.
     *
     * @return self
     */
     ...
     * Sets phoneNumber
     *
     * @param string|null $phoneNumber The individual's phone number, specified as 10-14 digits with an optional `+` prefix.
     *
     * @return self
     */
