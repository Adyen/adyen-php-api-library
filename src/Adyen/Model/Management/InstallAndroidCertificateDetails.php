...
class InstallAndroidCertificateDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InstallAndroidCertificateDetails';
    ...
    public const TYPE_INSTALL_ANDROID_CERTIFICATE = 'InstallAndroidCertificate';
    ...
    {
        return [
            self::TYPE_INSTALL_ANDROID_CERTIFICATE,
        ];
    }
    /**
    ...
    */
     ...
     * Sets certificateId
     *
     * @param string|null $certificateId The unique identifier of the certificate to be installed.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of terminal action: Install an Android certificate.
     *
     * @return self
     */
