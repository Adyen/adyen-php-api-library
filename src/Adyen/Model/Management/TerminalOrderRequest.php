...
class TerminalOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        return $this->container['billingEntityId'];
    }
     ...
     *
     * @param string|null $customerOrderReference The merchant-defined purchase order reference.
     *
     * @return self
     */
     ...
     *
     * @param string|null $shippingLocationId The identification of the shipping location to use for the order.
     *
     * @return self
     */
