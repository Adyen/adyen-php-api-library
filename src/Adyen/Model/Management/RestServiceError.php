...
class RestServiceError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'error_code' => 'string',
        'instance' => 'string',
        'invalid_fields' => '\Adyen\Model\Management\InvalidField[]',
        'request_id' => 'string',
    ...
    */
     ...
     * Sets invalid_fields
     *
     * @param \Adyen\Model\Management\InvalidField[]|null $invalid_fields Detailed explanation of each validation error, when applicable.
     *
     * @return self
     */
