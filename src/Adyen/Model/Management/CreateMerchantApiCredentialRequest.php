...
/**
 * CreateMerchantApiCredentialRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CreateMerchantApiCredentialRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMerchantApiCredentialRequest';
    ...
    */
     ...
     *
     * @param string[]|null $allowed_origins The list of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
     *
     * @return self
     */
