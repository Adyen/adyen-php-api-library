...
class CreateMerchantApiCredentialRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets allowedOrigins
     *
     * @param string[]|null $allowedOrigins The list of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.
     *
     * @return self
     */
