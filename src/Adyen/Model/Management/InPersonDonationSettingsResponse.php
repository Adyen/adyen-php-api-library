...
/**
 * InPersonDonationSettingsResponse Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class InPersonDonationSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InPersonDonationSettingsResponse';
    ...
    protected static $openAPITypes = [
        'amounts' => '\Adyen\Model\Management\DonationAmount[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('defaultCurrency', $data ?? [], null);
    ...
    */
     ...
     * Sets amounts
     *
     * @param \Adyen\Model\Management\DonationAmount[]|null $amounts The currency and fixed amounts for donations. We automatically add calculated amounts in other currencies for participating stores that use a different currency than the default.
     *
     * @return self
     */
     ...
     *
     * @param string|null $defaultCurrency The currency that was used in the request to set fixed donation amounts. Format: three-character [ISO currency code](https://docs.adyen.com/development-resources/currency-codes#currency-codes).
     *
     * @return self
     */
     ...
     *
     * @param int|null $presentCardTimeoutMs The time, in milliseconds, that the terminal waits for the shopper to present their card.
     *
     * @return self
     */
     ...
     *
     * @param int|null $promptTimeoutMs The time, in milliseconds, that the terminal waits for the shopper to respond to the text asking for a donation.
     *
     * @return self
     */
