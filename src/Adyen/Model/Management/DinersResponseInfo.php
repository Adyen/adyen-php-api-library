...
/**
 * DinersResponseInfo Class Doc Comment
 *
 * @package  Adyen
 * @implements ArrayAccess<string, mixed>
 */
class DinersResponseInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DinersResponseInfo';
    ...
    protected static $openAPITypes = [
        ...
        'reuseMidNumber' => 'bool',
        'serviceLevel' => 'string',
        'transactionDescription' => '\Adyen\Model\Management\TransactionDescriptionResponseInfo'
    ];
    ...
    */
     ...
     * Sets midNumber
     *
     * @param string|null $midNumber MID (Merchant ID) number.
     *
     * @return self
     */
     ...
     * Sets reuseMidNumber
     *
     * @param bool|null $reuseMidNumber Indicates whether the JCB Merchant ID is reused from a previously configured JCB payment method.
     *
     * @return self
     */
     ...
     * Sets serviceLevel
     *
     * @param string|null $serviceLevel The service level (settlement type) of this payment method. Possible values:  * **noContract**: Adyen holds the contract with JCB.  * **gatewayContract**: JCB receives the settlement and handles disputes, then pays out to you or your sub-merchant directly.
     *
     * @return self
     */
     ...
     *
     * @return \Adyen\Model\Management\TransactionDescriptionResponseInfo|null
     */
     ...
     *
     * @param \Adyen\Model\Management\TransactionDescriptionResponseInfo|null $transactionDescription transactionDescription
     *
     * @return self
     */
