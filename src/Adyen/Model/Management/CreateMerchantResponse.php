...
class CreateMerchantResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $business_line_id The unique identifier of the [business line](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/businessLines).
     *
     * @return self
     */
     ...
     * Sets company_id
     *
     * @param string|null $company_id The unique identifier of the company account.
     *
     * @return self
     */
     ...
     *
     * @param string|null $legal_entity_id The unique identifier of the [legal entity](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities).
     *
     * @return self
     */
     ...
     * Sets pricing_plan
     *
     * @param string|null $pricing_plan Partner pricing plan for the merchant, applicable for merchants under AfP managed company accounts.
     *
     * @return self
     */
