...
class Settings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets band
     *
     * @param string|null $band The preferred Wi-Fi band, for use if the terminals support multiple bands. Possible values: All, 2.4GHz, 5GHz.
     *
     * @return self
     */
     ...
     * Sets roaming
     *
     * @param bool|null $roaming Indicates whether roaming is enabled on the terminals.
     *
     * @return self
     */
     ...
     * Sets timeout
     *
     * @param int|null $timeout The connection time-out in seconds. Minimum value: 0.
     *
     * @return self
     */
