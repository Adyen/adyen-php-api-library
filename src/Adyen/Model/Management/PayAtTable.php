...
class PayAtTable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'enablePayAtTable' => 'setEnablePayAtTable',
    ...
    protected static $getters = [
        ...
        'enablePayAtTable' => 'getEnablePayAtTable',
    ...
    public const PAYMENT_INSTRUMENT_CASH = 'Cash';
    public const PAYMENT_INSTRUMENT_CARD = 'Card';
    ...
    {
        return [
            self::PAYMENT_INSTRUMENT_CASH,
            self::PAYMENT_INSTRUMENT_CARD,
        ];
    }
    /**
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('enablePayAtTable', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['authenticationMethod']) && !in_array($this->container['authenticationMethod'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                ...
                $this->container['authenticationMethod'],
     ...
     *
     * @param string|null $authenticationMethod Allowed authentication methods: Magswipe, Manual Entry.
     *
     * @return self
     */
    ...
    /**
     * Gets enablePayAtTable
     *
     * @return bool|null
     */
    public function getEnablePayAtTable()
    {
        return $this->container['enablePayAtTable'];
    }

    /**
     * Sets enablePayAtTable
     *
     * @param bool|null $enablePayAtTable Enable Pay at table.
     *
     * @return self
     */
     ...
     *
     * @param string|null $paymentInstrument Sets the allowed payment instrument for Pay at table transactions.  Can be: **cash** or **card**. If not set, the terminal presents both options.
     *
     * @return self
     */
