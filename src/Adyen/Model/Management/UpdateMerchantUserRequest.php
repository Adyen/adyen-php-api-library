...
/**
 * UpdateMerchantUserRequest Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class UpdateMerchantUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateMerchantUserRequest';
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active Sets the status of the user to active (**true**) or inactive (**false**).
     *
     * @return self
     */
