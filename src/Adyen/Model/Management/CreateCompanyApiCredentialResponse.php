...
class CreateCompanyApiCredentialResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['associatedMerchantAccounts'] === null) {
            $invalidProperties[] = "'associatedMerchantAccounts' can't be null";
        }
     ...
     *
     * @param string[] $associatedMerchantAccounts List of merchant accounts that the API credential has access to.
     *
     * @return self
     */
