...
/**
 * CreateCompanyApiCredentialResponse Class Doc Comment
 *
 * @category Class
 * @package  Adyen
 ...
 */
class CreateCompanyApiCredentialResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCompanyApiCredentialResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['associated_merchant_accounts'] === null) {
            $invalidProperties[] = "'associated_merchant_accounts' can't be null";
        }
     ...
     *
     * @param string[] $associated_merchant_accounts List of merchant accounts that the API credential has access to.
     *
     * @return self
     */
