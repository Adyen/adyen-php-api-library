...
class TransferInstruments extends AbstractPlatformsResource
{
    const TRANSFER_INSTRUMENT_BY_ID = '/transferInstruments/{id}';
    const TRANSFER_INSTRUMENT_CREATE = '/transferInstruments';
    ...
    public function find(array $queryParams = [])
    {
        return $this->simulateEndpoint(
            ...
            self::TRANSFER_INSTRUMENT_BY_ID,
    ...
    public function create($params)
    {
        return $this->simulateEndpoint(
            $this->service->getClient()->getPlatformsLemVersion(),
            self::TRANSFER_INSTRUMENT_CREATE,
            function () use ($params) {
