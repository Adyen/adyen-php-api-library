...
class PINFunctionalityApi extends Service
{
    /**
    ...
    /**
     * PINFunctionalityApi constructor.
     *
    ...
    * @throws AdyenException
    */
    public function getRsaPublickey(array $requestOptions = null): \Adyen\Model\BalancePlatform\PublicKeyResponse
    {
        $endpoint = $this->baseURL . "/pins/publicKey";
    ...
    * @throws AdyenException
    */
    public function changePin(\Adyen\Model\BalancePlatform\PinChangeRequest $pinChangeRequest, array $requestOptions = null): \Adyen\Model\BalancePlatform\PinChangeResponse
    {
    ...
    * @throws AdyenException
    */
    public function revealPin(\Adyen\Model\BalancePlatform\RevealPinRequest $revealPinRequest, array $requestOptions = null): \Adyen\Model\BalancePlatform\RevealPinResponse
    {
