...
class PaymentInstrumentsApi extends Service
{
    ...
    * @throws AdyenException
    */
    public function createNetworkTokenActivationData(string $id, \Adyen\Model\BalancePlatform\NetworkTokenActivationDataRequest $networkTokenActivationDataRequest, ?array $requestOptions = null): \Adyen\Model\BalancePlatform\NetworkTokenActivationDataResponse
    {
