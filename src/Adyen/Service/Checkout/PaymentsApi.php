...
class PaymentsApi extends Service
{
    ...
    public function __construct(Client $client)
    {
        ...
        $this->baseURL = $this->createBaseUrl("https://checkout-test.adyen.com/v72");
    }
    ...
    *
    * @param string $sessionId
    * @param \Adyen\Model\Checkout\CheckoutSessionPatchSessionRequest $checkoutSessionPatchSessionRequest
    * @param array|null $requestOptions
    * @return \Adyen\Model\Checkout\CheckoutSessionPatchSessionResponse
    * @throws AdyenException
    */
    public function updateSession(string $sessionId, \Adyen\Model\Checkout\CheckoutSessionPatchSessionRequest $checkoutSessionPatchSessionRequest, ?array $requestOptions = null): \Adyen\Model\Checkout\CheckoutSessionPatchSessionResponse
    {
        $endpoint = $this->baseURL . str_replace(['{sessionId}'], [$sessionId], "/sessions/{sessionId}");
        $response = $this->requestHttp($endpoint, strtolower('PATCH'), (array) $checkoutSessionPatchSessionRequest->jsonSerialize(), $requestOptions);
        return ObjectSerializer::deserialize($response, \Adyen\Model\Checkout\CheckoutSessionPatchSessionResponse::class);
    }
}
