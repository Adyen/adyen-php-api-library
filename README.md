...
| [Adyen BinLookup API](https://docs.adyen.com/api-explorer/BinLookup/latest/overview)                        | Endpoints for retrieving information, such as cost estimates, and 3D Secure supported version based on a given BIN. Current supported version                                                                                                                     | [BinLookup](src/Adyen/Service/BinLookupApi.php)                      | **v54**                                                          |
