...
[![Packagist version](https://img.shields.io/packagist/v/adyen/php-api-library.svg?color=blue&style=popout)](https://packagist.org/packages/adyen/php-api-library)
...
| [Payments App API](https://docs.adyen.com/api-explorer/payments-app/1/overview)                                  | The Payments App API is used to Board and manage the Adyen Payments App on your Android mobile devices. | [PaymentsAppApi](src/Adyen/Service/PaymentsApp/PaymentsAppApi.php)                         | **v1**                  |
| [Foreign Exchange API](https://docs.adyen.com/api-explorer/foreignexchange/1/overview)                     | The Foreign Exchange API provides an endpoint that you can use to calculate the amounts and rates required to convert the currency of a transaction.                                                                                                                                                                                    | [ForeignExchange](src/Adyen/Service/ForeignExchange)                    | **v1**                   |
